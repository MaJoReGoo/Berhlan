   ...
   var runSideMenu = function(options) {
      ...
      $("#sidebar_left_toggle").on('click', function () {
         ...
         if (Body.hasClass('sb-l-m')) {
            ...
            $('#sidebar_left').on('mouseenter', sidebarLeftToggle);
            $('#sidebar_left').on('mouseleave', sidebarLeftToggle);
         } else {
            $('#sidebar_left').off('mouseenter', sidebarLeftToggle);
            $('#sidebar_left').off('mouseleave', sidebarLeftToggle);
            console.log("quitar");
         }
      });
      $("#sidebar_right_toggle").on('click', sidebarRightToggle);

      if ($('#sidebar_left').is(':hover')) {
         sidebarLeftToggle();
         $('#sidebar_left').on('mouseenter', sidebarLeftToggle);
         $('#sidebar_left').on('mouseleave', sidebarLeftToggle);
      } else {
