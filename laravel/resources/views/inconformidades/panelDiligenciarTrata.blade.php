...
<link rel="stylesheet" type="text/css" href="{{ asset ('/public/css/inconformidades/panelDiligenciarTrata.blade.css')}}">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="allcp-form">
                                                        <form id="completarTratamientoNoConf"
                                                            action="{{ route('completarTratamientoNoConf') }}"
                                                            method="post" enctype="multipart/form-data">
                                                            @csrf

                                                            <div class="row">

                                                                <input type="text" hidden name="id_tratamiento"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <textarea name="descripcion_inme_trata[]" id="descripcion_tratamiento"
                                                                                style="width: 100%; border-radius: 4px;border-color: #e3e3e3" required
                                                                                {{ $value->descripcion_inme_trata ? 'disabled' : '' }}>{{ $value->descripcion_inme_trata }}</textarea>
                                                            ...
                                                            <br>
                                                            <br>
                                                            @if ($registro_tratamiento_inme[0]->descripcion_inme_trata === null)
                                                                <div class="box"
                                                                    ...
                                                                    <button id="btn_actualizar" type="submit"
                                                                        ...
                                                                        Diligenciar tratamiento de no conformidad
                                                                        </img>
                                                                    </button>
                                                                </div>
                                                            @endif
