        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
             ...
             {{--  <a href="<?=$server?>/panel/parametrizacion/cargos/agregar" class="btn btn-primary btn-sm ml10" title="Nuevo cargo">
              ...
              <div class="panel m10">
                ...
                <div class="table-responsive">
                  ...
                  <table id="message-table" class="table tc-checkbox-1 allcp-form theme-warning br-t table-striped">
                    ...
                    <tbody>
                      <?php $u = 1; ?>
                      @foreach($DatosCargos as $DatCargos)
                        <?php
                        if($DatCargos->estado == '0')
                          $color = '#F6565A';
                        else
                          $color = '#AEBF25';
                        ?>
                        ...
                        <tr class="message-unread">
                          ...
                          <td style="text-align: left ">
                            <i class="fa fa-book fa-lg" style="color:<?=$color?>;"></i>
                            &nbsp;
                            <font color="#2A2F43">
                              <b>
                                <?=$DatCargos->descripcion?>
                              </b>
                            </font>
                          </td>

                          <?php
                          $Area = PanelAreas::getArea($DatCargos->area);
                          ?>
                          <td style="text-align: left">
                          ...
                          <td style="text-align: center">
                            <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/parametrizacion/cargos/modificar/<?=$DatCargos->id_cargo?>'">
