...
@foreach($DatosUsuario as $DatLog)
  ...
  <html>
    <head>
      ...
      <meta charset="utf-8">
      <title>
        Intranet | Agregar centro de operación
      </title>
                    ...
                    <table id="message-table" class="table allcp-form theme-warning br-t">
                      <thead>
                        <tr style="background-color:#39405a">
                          <th>
                            Ingrese la información del centro de operación
                          </th>
                        </tr>
                      </thead>
                        ...
                        <tr>
                          <td>
                            <div class="allcp-form">
                              {!! Form::open(array('action' => 'Parametrizacion\CentrosOpPanelController@CentrosOpAgregarDB', 'class' => 'form', 'id'=>'form-wizard', 'files' => true)) !!}
                                ...
                                <div class="section">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <label class="field prepend-icon">
                                      {!! Form::text('direccion', null, array('required', 'id'=>'direccion', 'class'=>'gui-input', 'placeholder'=>'* Dirección')) !!}
                                      <label for="username" class="field-icon">
                                ...
                                <div class="section">
                                  <div class="col-md-5">
                                    ...
                                    <label class="field prepend-icon">
                                      {!! Form::number('tel1', null, array('', 'id'=>'tel1', 'class'=>'gui-input', 'placeholder'=>'Teléfono 1')) !!}
                                      <label for="username" class="field-icon">
                                  ...
                                  <div class="col-md-5">
                                    ...
                                    <label class="field prepend-icon">
                                      {!! Form::number('tel2', null, array('', 'id'=>'tel2', 'class'=>'gui-input', 'placeholder'=>'Teléfono 2')) !!}
                                      <label for="username" class="field-icon">
                                        <i class="fa fa-phone"></i>
                                      </label>
                                    </label>
                                ...
                                <div class="section">
                                  <div class="col-md-8">
                                    <br><br>
                                    {!! Form::submit('Ingresar centro de operación', array('class'=>'button')) !!}
                                  </div>
                                </div>
                              {!! Form::close() !!}
                            </div>
