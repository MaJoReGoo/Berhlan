        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
             ...
             {{--  <a href="<?=$server?>/panel/parametrizacion/centrosop/agregar" class="btn btn-primary btn-sm ml10" title="Nuevo centro de operación">
              ...
              <div class="panel m10">
                ...
                <div class="table-responsive">
                  ...
                  <div style="padding-left: 10px">
                    Cantidad de centros de operación:
                    <?=$CentrosOpActivos+$CentrosOpInactivos?>
                    <font color="#b4c056">
                      (<?=$CentrosOpActivos?>)
                    </font>
                  </div>
                  ...
                  <table id="message-table" class="table tc-checkbox-1 allcp-form theme-warning br-t table-striped">
                    ...
                    <tbody>
                      <?php $u = 1; ?>
                      @foreach($DatosCentrosOp as $DatCen)
                        <?php
                        if($DatCen->estado == '0')
                          $color = '#F6565A';
                        else
                        ...
                        <tr class="message-unread">
                          ...
                          <td style="text-align: left ">
                            <i class="fa fa-university fa-lg" style="color:<?=$color?>;"></i>
                            &nbsp;
                            <font color="#2A2F43">
                              <b>
                                <?=$DatCen->descripcion?>
                          ...
                          <td style="text-align: left ">
                            <font color="#2A2F43">
                              <?php
                              echo $DatCen->direccion;
                              echo "<br>";
                              $Ciudad = PanelCiudades::getCiudad($DatCen->ciudad);
                              ?>
                              @foreach($Ciudad as $DatCiudad)
                                <?php
                                echo $DatCiudad->nom_ciudad;
                                echo " - ";
                                echo $DatCiudad->nom_depto;
                                ?>
                              @endforeach
                            </font>
                          </td>
                          ...
                          <td style="text-align: center">
                            <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/parametrizacion/centrosop/modificar/<?=$DatCen->id_centro?>'">
