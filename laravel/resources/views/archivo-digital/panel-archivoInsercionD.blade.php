...
@foreach ($DatosUsuario as $DatLog)
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('/public/css/archivo-digital/panel-archivoInsercionD.blade.css') }}">
                                                        ...
                                                        <td>
                                                            @if ($DatReFu->estado == 1)
                                                                <button id="btn_adjuntar" type="button"
                                                                    ...
                                                                    onclick="window.location.href='{{ asset ('/panel/archivo/inserciond/recibir/')}}<?= $DatReFu->id_solicitud ?>'">
                                                                    <img
                                                            ...
                                                            @if ($DatReFu->estado == 2 || $DatReFu->estado == 3)
                                                                <button id="btn_adjuntar" type="button"
                                                                    class="btn mb-2" style="background: none"
                                                                    onclick="window.location.href='{{ asset ('/panel/archivo/inserciond/escaner/')}}<?= $DatReFu->id_solicitud ?>'">
                                                                    <img
