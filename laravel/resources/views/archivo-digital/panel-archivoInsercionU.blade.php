...
@foreach ($DatosUsuario as $DatLog)
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('/public/css/archivo-digital/panel-archivoInsercionU.blade.css') }}">

        @include('archivo-digital.modales.modal-insercionU')
    </head>
                                ...
                                <div class="card card-spacing">
                                    <div class="card-body rqs shadow bg-body rounded" style="float: right">
                                        <button id="btn_adjuntar" type="button" class="btn btn-primary mb-2"
                                            data-toggle="modal" data-target="#agregarInsercion">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button id="btn_adjuntar" type="button" class="btn mb-2"
                                                                ...
                                                                onclick="window.location.href='{{ asset ('/panel/archivo/insercionu/recibir/')}}<?= $DatReFu->id_solicitud ?>'">
                                                                <img src="{{ asset ('/images/info.png')}}"></img>
                                                            </button>
                                                        </td>
