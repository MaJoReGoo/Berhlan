        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/bpack/penaprcontrato" title="Bcloud > Solicitudes pendientes de > Solicitudes pendientes de aprobación prueba de contrato física">
                    <font color="#34495e">
                      Bcloud > Solicitudes pendientes de > Solicitudes pendientes de aprobación prueba de contrato física >
                    </font>
                    <font color="#b4c056">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/bpack/penaprcontrato" class="btn btn-primary btn-sm ml10" title="Bcloud > Solicitudes pendientes de > Solicitudes pendientes de aprobación prueba de contrato física">
                REGRESAR &nbsp;
          ...
          <section id="content" class="table-layout animated fadeIn">
            <div class="chute chute-center pt20">
              <!-- -------------- Column Center -------------- -->
              {!! Form::open(array('action' => 'Bpack\AprContratoPanelController@PendientesAprContratoProcesarDB', 'class' => 'form', 'id'=>'form-wizard', 'files' => true, 'name' => 'frmenvio')) !!}
                        ...
                        <tbody>
                          ...
                          <div class="allcp-form">
                            ...
                            @foreach($DetSolicitud as $DatSol)
                              {!! Form::hidden('regaprobado_'.$DatSol->registro, $DatSol->aprobado2) !!}
                              <tr>
                                <th>
                                  ...
                                  if($DatSol->aprobado2 != "S")
                                   {
                                    ...
                                    <label class="field prepend-icon append-button file">
                                      ...
                                      <?php
                                      $textarc1 = "uploader2_".$reg;
                                      ?>
                                      {!! Form::file('file2_'.$reg, array('required', 'id'=>'file2_'.$reg, 'class'=>'gui-file', 'accept'=>'.pdf, .rar, .zip',
                                          'onChange'=>"document.getElementById('$textarc1').value = this.value;")) !!}
                                      {!! Form::text($textarc1, null, array('id'=>$textarc1, 'class'=>'gui-input', 'placeholder'=>'Seleccione el archivo')) !!}
                                      <label class="field-icon">
                                        <i class="fa fa-cloud-upload"></i>
                                      </label>
                                    </label>
                    ...
                    function HABILITAR(id1, id2)
                     {
                      ...
                      tipo = frm.tipo.value;
                      cadf = document.getElementById('file2_'+id2);
                      cadv = document.getElementById('version_'+id2);
                      cadm = document.getElementById('motivo_'+id2);
                      cadi = document.getElementById('item_'+id2);

                      if(tipo == "SBA")
                       {
                        cada = document.getElementById('file1_'+id2);
                       }
                      else
                       {
                        arte    = document.getElementById('fileT1');
                        formato = document.getElementById('fileT2');
                       }
                    ...
                    <table id="message-table" class="table allcp-form theme-warning br-t">
                        ...
                        <tr style="background-color:#67d3e0">
                          <th style="color:black; text-align:left;">
                            ...
                            if($inicio == "SBM")
                              ...
                              echo $DatosSolicitud[0]->id_actualizacion;
                            ?>
                            - Pasará a pendientes de prueba de contrato física
                          </th>
                        </tr>
                      </thead>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div class="allcp-form">
                              {!! Form::open(array('action' => 'Bpack\AprContratoPanelController@RechazarDB', 'class' => 'form', 'id'=>'form-wizard', 'name' => 'frmenvio')) !!}
                                {!! Form::hidden('solicitud', $DatosSolicitud[0]->id_solicitud) !!}
                                <div class="row">
                                  <div class="col-md-3">
                                    <label style="color:#34495e;">
