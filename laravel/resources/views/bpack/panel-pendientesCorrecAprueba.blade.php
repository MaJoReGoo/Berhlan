          ...
          <ul class="nav nav-list nav-list-topbar pull-left">
            <li class="active">
              <a href="{{ asset ('/panel/bpack/solpendientes')}}" title="Bcloud > Solicitudes pendientes de">
                ...
                <font color="#b4c056">
                  Solicitudes pendientes de corrección por rechazo en aprobación
                </font>
              </a>
            </li>
          </ul>
          ...
          <div class="panel m10">
            ...
            <div class="table-responsive">
              ...
              <div style="padding-left: 10px">
                Publicidad - Solicitudes pendientes de corrección por rechazo en aprobación
              </div>
              <table id="message-table" class="table tc-checkbox-1 allcp-form theme-warning br-t table-striped">
                ...
                <tbody>
                  <?php $u = 1; ?>
                  @foreach($PenCorAprueba as $DatCor)
                  <?php
                  ...
                  <tr class="message-unread">
                    ...
                    <td style="text-align: justify;">
                      <font color="#2A2F43">
                        ...
                        $b = 0;
                        if ($inicio == "SBA") {
                          $conflexo = PanelSolicitudesAN::SolDetConFlexo($DatCor->id_solicitud);
                        ?>
                          Ítem:
                        ...
                        <?php
                          ...
                          $cantipo = PanelSolicitudesAN::SolDetCan($DatCor->id_solicitud);
                        ?>
                    ...
                    <td style="text-align: center;">
                      <font color="#2A2F43">
                        <?php
                        if ($DatCor->estado == 3) {
                          $tipoCorrecion = 'Pendiente de Corrección';
                        }

                        if ($DatCor->estado == 10) {
                          $tipoCorrecion = 'Rechazo por Ruta';
                        }
                        ?>
                        <?= $tipoCorrecion ?>
                      </font>
                    ...
                    <td style="text-align: center">
                      <font color="#2A2F43">
                        <?php
                        $rechazadop = PanelSolicitudesAN::UltimoRechazoAprueba($DatCor->id_solicitud);
