          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="{{ asset ('/panel/bpack/reclamos')}}" title="Bcloud > Consulta reclamos y quejas">
                    <font color="#34495e">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="{{ asset ('/panel/bpack/reclamos')}}" class="btn btn-primary btn-sm ml10" title="Bcloud > Consulta reclamos y quejas">
                REGRESAR &nbsp;
                            ...
                            <tr style="background-color: #F8F8F8; color:#000000">
                              ...
                              <td style="text-align:left" colspan="3">
                                ...
                                if($DatosReclamo[0]->archivo != '')
                                 {
                                  ?>
                                  <button type="button" style="background:#f7f9f9;" class="btn btn-default light" onclick="window.open('{{ asset ('/archivos/Bpack/Reclamos/')}}<?=$DatosReclamo[0]->archivo?>','_blank')" title="<?=$DatosReclamo[0]->archivo?>">
                              ...
                              <tr style="background-color: #F8F8F8; color:#000000">
                                ...
                                <td style="text-align:left">
                                  ...
                                  if($DatosReclamo[0]->registro_envio != '')
                                   {
                                    ?>
                                    <button type="button" style="background:#f7f9f9;" class="btn btn-default light" onclick="window.open('{{ asset ('/archivos/Bpack/Reclamos/')}}<?=$DatosReclamo[0]->registro_envio?>','_blank')" title="<?=$DatosReclamo[0]->registro_envio?>">
                                      <i class="fa fa-file-image-o fa-lg" style="color:#b4c056;"></i>
                                    </button>
                                    <?php
                                   }
