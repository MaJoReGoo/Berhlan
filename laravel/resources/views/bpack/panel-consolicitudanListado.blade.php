          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/bpack/consolicitudan" title="Bcloud > Consulta solicitudes">
                    <font color="#34495e">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/bpack/consolicitudan" class="btn btn-primary btn-sm ml10" title="Bcloud > Consulta solicitudes">
                REGRESAR &nbsp;
                        ...
                        if($DatCon->id_solicitud != $sol)
                         {
                          ...
                          <tr class="message-unread">
                            ...
                            <td style="text-align: center">
                              <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/bpack/consolicitudan/masinfo/<?=$DatCon->id_solicitud?>'">
