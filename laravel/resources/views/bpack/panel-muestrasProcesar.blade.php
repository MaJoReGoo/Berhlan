                            ...
                            <tr style="background-color: #F8F8F8; color:#000000">
                              ...
                              <td style="text-align:justify;">
                                ...
                                if($DatosMuestra[0]->archivo != '')
                                 {
                                  ?>
                                  <button type="button" style="background:#f7f9f9;" class="btn btn-default light" onclick="window.open('<?=$server?>/archivos/Bpack/Muestras/<?=$DatosMuestra[0]->archivo?>','_blank')" title="<?=$DatosMuestra[0]->archivo?>">
