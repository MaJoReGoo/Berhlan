...
@foreach ($DatosUsuario as $DatLog)
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>
            Intranet | Bcloud | Solicitudes pendientes de aprobación sherpas
        </title>
                ...
                <header id="topbar" class="ph10">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            <li class="active">
                                <a href="{{ asset ('/panel/bpack/solpendientes')}}"
                                    title="Bcloud > Solicitudes pendientes de">
                                    <font color="#34495e">
                                        Bcloud > Solicitudes pendientes de >
                                    </font>
                                    <font color="#b4c056">
                                        Solicitudes pendientes de aprobación sherpas digitales
                                    </font>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
                        <a href="{{ asset ('/panel/bpack/solpendientes')}}" class="btn btn-primary btn-sm ml10"
                            title="Bcloud > Solicitudes pendientes de">
                            REGRESAR &nbsp;
                        ...
                        <div class="panel m10">
                            ...
                            <div class="table-responsive">
                                <div style="padding-left: 10px">
                                    Publicidad - Solicitudes pendientes de aprobación sherpas digitales
                                </div>
                                <table id="message-table"
                                    ...
                                    <tbody>
                                        <?php $u = 1; ?>
                                        @foreach ($PenSherpa as $DatShe)
                                            <?php
                                            if ($DatShe->id_nvdesarrollo != 0) {
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <font color="#2A2F43">
                                                        <b>
                                                            ...
                                                            echo $inicio;
                                                            if ($inicio == 'SBM') {
                                                                echo $DatShe->id_nvdesarrollo;
                                                            } else {
                                                                echo $DatShe->id_actualizacion;
                                                            }
                                                            ?>
                                                        </b>
                                                    </font>
                              ...
                              if($inicio == "SBA")
                               {
                                $conflexo = PanelSolicitudesAN::SolDetConFlexo($DatShe->id_solicitud);
                                ?>
                                                        Ítem:
                               ...
                               {
                                $cantipo = PanelSolicitudesAN::SolDetCan($DatShe->id_solicitud);
                                ?>
                              ...
                              ?>
                                                ...
                                                <td style="text-align: center">
                                                    <font color="#2A2F43">
                                                        <?php
                                                        $empleado = PanelEmpleados::getEmpleado($DatShe->usr_crea);
                                                ...
                                                <td style="text-align: center;">
                                                    <font color="#6CBCED">
                                                        <?php
                                                        $fecha1 = new DateTime($DatShe->fecha_crea);
                                                ...
                                                <td style="text-align: center">
                                                    <button type="button" class="btn btn-default light"
                                                        onclick="window.location.href='{{ asset ('/panel/bpack/pensherpa/procesar/')}}<?= $DatShe->id_solicitud ?>'">
