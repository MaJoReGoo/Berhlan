...
@foreach($DatosUsuario as $DatLog)
  ...
  <html>
    <head>
      ...
      <meta charset="utf-8">
      <title>
        Intranet | Bcloud | Consulta solicitud
      </title>
          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="javascript:history.back()" title="Bcloud > Consulta solicitudes > Listado">
                    <font color="#34495e">
                      Bcloud > Consulta solicitudes > Listado >
                    </font>
                    <font color="#b4c056">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="javascript:history.back()" class="btn btn-primary btn-sm ml10" title="Bcloud > Consulta solicitudes > Listado">
                REGRESAR &nbsp;
