...
@foreach($DatosUsuario as $DatLog)
  ...
  <html>
    <head>
      ...
      <meta charset="utf-8">
      <title>
        Intranet | Bcloud | Solicitud pendiente de prueba contrato
      </title>
          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/bpack/pencontrato" title="Bcloud > Solicitudes pendientes de > Solicitudes pendientes de prueba contrato física">
                    <font color="#34495e">
                      Bcloud > Solicitudes pendientes de > Solicitudes pendientes de prueba contrato física >
                    </font>
                    <font color="#b4c056">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/bpack/pencontrato" class="btn btn-primary btn-sm ml10" title="Bcloud > Solicitudes pendientes de > Solicitudes pendientes de prueba contrato física">
                REGRESAR &nbsp;
                    ...
                    <table id="message-table" class="table allcp-form theme-warning br-t">
                      <tbody>
                        ...
                        <div class="allcp-form">
                          {!! Form::open(array('action' => 'Bpack\ContratoPanelController@PendientesContratoProcesarDB', 'class' => 'form', 'id'=>'form-wizard', 'name' => 'frmenvio')) !!}
                                  ...
                                  if($DatSol->aprobado2 == "S")
                                  ...
                                  else
                                   {
                                    ...
                                    <label class="field prepend-icon">
                                      {!! Form::text('remision_'.$reg, $DatSol->remision, array('', 'id'=>'remision_'.$reg, 'class'=>'gui-input', 'placeholder'=>'Remisión')) !!}
