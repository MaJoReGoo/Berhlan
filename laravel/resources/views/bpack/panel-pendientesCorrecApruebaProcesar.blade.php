      ...
      <header id="topbar" class="ph10">
        <div class="topbar-left">
          <ul class="nav nav-list nav-list-topbar pull-left">
            <li class="active">
              <a href="{{ asset ('/panel/bpack/correcaprueba/0')}}" title="Bcloud > Solicitudes pendientes de > Solicitudes pendientes de corrección por rechazo en aprobación">
                <font color="#34495e">
        ...
        <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
          <a href="{{ asset ('/panel/bpack/correcaprueba/0')}}" class="btn btn-primary btn-sm ml10" title="Bcloud > Solicitudes pendientes de > Solicitudes pendientes de corrección por rechazo en aprobación">
            REGRESAR &nbsp;
