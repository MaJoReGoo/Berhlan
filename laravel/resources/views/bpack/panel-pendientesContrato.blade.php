              ...
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/bpack/solpendientes" title="Bcloud > Solicitudes pendientes de">
                    ...
                    <font color="#b4c056">
                      Solicitudes pendientes de prueba contrato física
                    </font>
                  </a>
                </li>
              </ul>
              ...
              <div class="panel m10">
                ...
                <div class="table-responsive">
                  <div style="padding-left: 10px">
                    Preprensa - Solicitudes pendientes de prueba contrato física
                  </div>
                    ...
                    <tbody>
                      ...
                      @foreach($PenContrato as $DatCon)
                        ...
                        <tr class="message-unread">
                          ...
                          <td style="text-align: center">
                            <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/bpack/pencontrato/procesar/<?=$DatCon->id_solicitud?>'">
