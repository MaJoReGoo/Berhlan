              ...
              <div class="panel m10">
                ...
                <div class="table-responsive">
                  <div style="padding-left: 10px">
                    Preprensa - Solicitudes pendientes de aprobación solicitud
                  </div>
                  <table id="message-table" class="table tc-checkbox-1 allcp-form theme-warning br-t table-striped">
                    ...
                    <tbody>
                      <?php $u = 1; ?>
                      @foreach($PenAprueba as $DatApr)
                        <?php
                        if($DatApr->id_nvdesarrollo != 0)  //Si es nuevo desarrollo
                         {
                          $color  = '#21618c';
                          $inicio = "SBM";
                        ...
                        <tr class="message-unread">
                          ...
                          <td style="text-align: center;">
                            <font color="#2A2F43">
                              <?php
                              $estado = PanelSolicitudesAN::DesEstado($DatApr->estado);
                          ...
                          <td style="text-align: center">
                            <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/bpack/penaprueba/procesar/<?=$DatApr->id_solicitud?>'">
