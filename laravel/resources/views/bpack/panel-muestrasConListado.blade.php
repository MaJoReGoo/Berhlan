          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/bpack/muestrascon" title="Bcloud > Consulta solicitudes para impresión de muestras físicas">
                    <font color="#34495e">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/bpack/muestrascon" class="btn btn-primary btn-sm ml10" title="Bcloud > Consulta solicitudes para impresión de muestras físicas">
                REGRESAR &nbsp;
                          ...
                          <td style="text-align:center;">
                            <font color="#2A2F43">
                              ...
                              if($DatSol->archivo != '')
                               {
                                ?>
                                <button type="button" style="background:#f7f9f9;" class="btn btn-default light" onclick="window.open('<?=$server?>/archivos/Bpack/Muestras/<?=$DatSol->archivo?>','_blank')" title="<?=$DatSol->archivo?>">
