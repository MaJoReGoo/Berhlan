          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/menu/112" title="Activos TIC">
                    <font color="#34495e">
                      Activos Fijos >
                    </font>
                    <font color="#b4c056">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/menu/112" class="btn btn-primary btn-sm ml10" title="Activos TIC">
                REGRESAR &nbsp;
                        ...
                        <tr>
                          <td>
                            <div class="allcp-form">
                              {!! Form::open(array('action' => 'ActivosFijos\ConsultasActivosFijosController@ProyeccionListado', 'class' => 'form', 'id'=>'form-wizard')) !!}
                                <div class="row">
                                  <div class="col-md-4">
