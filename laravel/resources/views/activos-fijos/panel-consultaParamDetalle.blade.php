                ...
                <header id="topbar" class="ph10">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            <li class="active">
                                <a href="<?= $server ?>/panel/activos/consulta/parametrizada"
                                ...
                                if($DatosActivo[0]->acta_firmada != '')
                                 {
                                  ?>
                                                            <button type="button" style="background:#f7f9f9;"
                                                                class="btn btn-default light"
                                                                onclick="window.open('<?= $server ?>/archivos/Activostic/Actas_firmadas/<?= $DatosActivo[0]->acta_firmada ?>','_blank')"
                                ...
                                ?>
                                                    ...
                                                    <tr style="background-color: #F8F8F8; color:#000000">
                                                        ...
                                                        <td style="text-align:left">
                                                            <button type="button" class="btn btn-default light"
                                                                onclick="window.location.href='<?= $server ?>/panel/activos/acta/<?= $DatosActivo[0]->id_activo ?>'"
                                                                title="Acta">
                                                                <i class="fa fa-file-pdf-o fa-lg"
                                                                    style="color:red;"></i>
                                                            </button>
                                                ...
                                                <div
                                                    ...
                                                    <button type="button" class="btn btn-primary mb-2"
                                                        onclick="window.location.href='<?= $server ?>/panel/activos/modificaract/<?= $DatosActivo[0]->id_activo ?>'"
                                                        title="Modificar">
                                                        <img src="{{ $server }}/images/editar-codigo.png">
                                                        Editar
                                                        </img>
                                                    </button>
                                                </div>
