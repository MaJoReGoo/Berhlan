          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/activos/proyeccion" title="Activos TIC > Consulta proyección de mantenimientos">
                    <font color="#34495e">
                      Activos Fijos > Consulta proyección de mantenimientos >
                    </font>
                    <font color="#b4c056">
                      Resultado
                    </font>
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/activos/proyeccion" class="btn btn-primary btn-sm ml10" title="Activos TIC > Consulta proyección de mantenimientos">
                REGRESAR &nbsp;
                  ...
                  <table id="message-table" class="table tc-checkbox-1 allcp-form theme-warning br-t table-striped">
                    ...
                    <tbody>
                      ...
                      @foreach($DatosActivos as $DatAct)
                        ...
                        $Activo        = PanelActivosFijos::getActivo($acti);
