          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/ticactivos/ingresaract" title="Activos TIC > Agregar">
                    <font color="#34495e">
                      Activos TIC > Agregar >
                    </font>
                    <font color="#b4c056">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/ticactivos/ingresaract" class="btn btn-primary btn-sm ml10" title="Activos TIC > Agregar">
                REGRESAR &nbsp;
