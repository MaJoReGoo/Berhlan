        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/ticactivos/software/agregar" class="btn btn-primary btn-sm ml10" title="Nuevo software">
              ...
              <div class="panel m10">
                ...
                <div class="table-responsive">
                  ...
                  <div style="padding-left: 10px">
                    Cantidad software:
                    <?=$SoftwareActivos+$SoftwareInactivos?>
                    <font color="#b4c056">
                      (<?=$SoftwareActivos?>)
                    </font>
                  </div>
                      ...
                      @foreach($DatosSoftware as $DatSof)
                        ...
                        <tr class="message-unread">
                          ...
                          <td style="text-align: center">
                            <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/ticactivos/software/modificar/<?=$DatSof->id_software?>'">
