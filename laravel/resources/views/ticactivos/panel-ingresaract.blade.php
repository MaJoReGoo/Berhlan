                                            ...
                                            <tr>
                                                <td>
                                                    <div class="allcp-form">
                                                        {!! Form::open([
                                                            'action' => 'TicActivos\ActivosTicActivosPanelController@IngresarDet',
                                                            'class' => 'form',
                                                            'id' => 'form-wizard',
                                                        ]) !!}
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <label style="color: #34495e">
                                                                    <b>
                                                                        Recuerde que para crear un activo, es necesario
                                                                        tener previamente creada la marca y el modelo.
                                                                        Es posible que también necesite tener creada la
                                                                        licencia de office y el software.
                                                                    </b>
                                                                </label>
                                                            </div>
                                                            <div class="col-md-4">
