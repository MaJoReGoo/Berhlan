        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/ticactivos/tareas/agregar" class="btn btn-primary btn-sm ml10" title="Nueva tarea">
              ...
              <div class="panel m10">
                ...
                <div class="table-responsive">
                  ...
                  <div style="padding-left: 10px">
                    Cantidad tareas de mantenimiento:
                    <?=$TareasActivas+$TareasInactivas?>
                    <font color="#b4c056">
                      (<?=$TareasActivas?>)
                    </font>
                  </div>
                      ...
                      @foreach($DatosTareas as $DatTar)
                        ...
                        <tr class="message-unread">
                          ...
                          <td style="text-align: center">
                            <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/ticactivos/tareas/modificar/<?=$DatTar->id_tarea?>'">
