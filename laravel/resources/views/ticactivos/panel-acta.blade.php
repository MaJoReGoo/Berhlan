                ...
                <header id="topbar" class="ph10">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            <li class="active">
                                <a href="<?= $server ?>/panel/ticactivos/consultasparam" title="Activos TIC">
                                    <font color="#34495e">
                                        Activos TIC >
                                    </font>
                                    <font color="#b4c056">
                        ...
                        <div class="panel m4">
                                ...
                                <div class="table-responsive">
                                    <div id="imprime">
                                        <table id="message-table" class="table allcp-form theme-warning br-t">
                                            <tbody>
                                                <tr>
                                                    <th style="font-size:26px; color:#34495e; text-align:left;"
                                                        width="90%">
                                                        Acta de entrega activo fijo TIC No.
                                        ...
                                        <table id="message-table" class="table allcp-form theme-warning br-t"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="font-size:16px; color:#34495e; text-align:left;"
                                                        colspan="4">
                                                        Se hace entrega de
                                                        <b>
                                                            <font size="4">
                                                ...
                                                <tr>
                                                    <td style="font-size:16px; color:#34495e; text-align:left;"
                                                        colspan="4">
                                                        <table border="1" class="table theme-warning br-t"
                                                            width="100%" cellpadding="6" cellspacing="0">
                                                            <tr>
                                                                <th align="left">
                                                                    Marca y modelo:
                                                                </th>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                        ...
                                                                        @php
                                                                        if ( $Tipo[0]->descripcion === 'SIM CARD' ) { 
                                                                         echo $DatosActivo[0]->campo1;
                                                                         } else {
                                                                          echo   $DatosActivo[0]->activofijo;
                                                                        }
                                                                        @endphp
                                                ...
                                                <tr>
                                                    <td style="color:#34495e; text-align:justify;" colspan="4">
                                                        @php
                                                            $software = PanelSoftware::getSoftwares();
                                                        @endphp
                                                        <table>
                                                            <tr >
                                                                Se entrega con:
                                                                ...
                                                                @foreach ($software as $item)
                                                                    <td style="padding-right: 5px">
                                                                        &#9633;
                                                                        <label for="defaultCheck1" style="font-size: 10px">
                                                                            {{ $item->descripcion }}
                                                                        </label></td>
                                                                    @php
                                                                        $contador++;
                          ...
                          ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color:#34495e; font-size: 12px">
                                                        <?php
                                    ...
                                    &nbsp;&nbsp;
                                    <button class="btn btn-primary light" onclick="imprime('imprime')"
                                        style="background-color:#2b3980;">Imprimir</button>
                                    <br><br>
