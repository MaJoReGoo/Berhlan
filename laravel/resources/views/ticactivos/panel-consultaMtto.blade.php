...
@foreach($DatosUsuario as $DatLog)
  ...
  <html>
    <head>
      ...
      <meta charset="utf-8">
      <title>
        Intranet | Activos TIC | Consulta mantenimientos
      </title>
        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
              ...
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="{{ asset ('/panel/ticactivos/consultasact')}}" title="Activos TIC">
                    ...
                    <font color="#b4c056">
                      Consulta mantenimientos realizados
                    </font>
                  </a>
                </li>
              </ul>
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="{{ asset ('/panel/ticactivos/consultasact')}}" class="btn btn-primary btn-sm ml10" title="Activos TIC">
                REGRESAR &nbsp;
                        ...
                        <tr>
                          <td>
                            <div class="allcp-form">
                              {!! Form::open(array('action' => 'TicActivos\ConsultasTicActivosPanelController@MantenimientosListado', 'class' => 'form', 'id'=>'form-wizard')) !!}
                                <div class="row">
                                  <div class="col-md-4">
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <label class="field select">
                                      <select name="empleado" id="empleado">
                                        ...
                                        <?php
                                        $Empl = PanelConsultas::EmpleadosMtto();
                                        ?>
