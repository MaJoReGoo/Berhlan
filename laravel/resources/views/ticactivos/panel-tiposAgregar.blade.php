                                            ...
                                            <tr>
                                                <td>
                                                    <div class="allcp-form">
                                                        {!! Form::open([
                                                            'action' => 'TicActivos\TiposTicActivosPanelController@TiposAgregarDB',
                                                            'class' => 'form',
                                                            'id' => 'form-wizard',
                                                        ]) !!}
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <label style="text-align:justify;">
                                                                    Tamaño del DD - Tipo de DD - Tamaño de RAM - Tipo de
                                                                    RAM - Procesador - Licencia de office - Dirección
                                                                    MAC 2 - Dirección IP 2 - Control remoto - Licencia
                                                                    de Windows S/N - Software
                                                                </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <br>
                                                                {!! Form::submit('Ingresar tipo', ['class' => 'button']) !!}
                                                            </div>
                                                        </div>
                                                        {!! Form::close() !!}
                                                    </div>
