                          ...
                          <tbody>
                            ...
                            @foreach($DatosActivos as $DatAct)
                              <tr class="message-unread">
                                ...
                                <td style="text-align: center">
                                  <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/ticactivos/consultasparam/detalle/<?=$DatAct->id_activo?>'" title="Más información">
