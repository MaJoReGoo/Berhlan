                                                    ...
                                                    @foreach ($DatosActivosAsignados as $DatActAsi)
                                                        @if ($DatActAsi->tipo_identificacion == 'Igual')
                                                            <tr class="message-unread">
                                                                ...
                                                                <td style="text-align:center;">
                                                                    <button type="button" class="btn btn-default light" onclick="window.location.href='{{ asset ('/panel/ticactivos/consultasparam/detalle/')}}<?=$DatActAsi->activo?>'" title="Más información">
