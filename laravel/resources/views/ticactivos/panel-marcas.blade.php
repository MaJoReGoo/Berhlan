        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/ticactivos/marcas/agregar" class="btn btn-primary btn-sm ml10" title="Nueva marca">
              ...
              <div class="panel m10">
                ...
                <div class="table-responsive">
                  ...
                  <div style="padding-left: 10px">
                    Cantidad marcas y modelos:
                    <?=$MarcasActivas+$MarcasInactivas?>
                    <font color="#b4c056">
                      (<?=$MarcasActivas?>)
                    </font>
                  </div>
                      ...
                      @foreach($DatosMarcas as $DatMar)
                        ...
                        <tr class="message-unread">
                          ...
                          <td style="text-align: center">
                            <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/ticactivos/marcas/modificar/<?=$DatMar->id_marca?>'">
