        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/ticactivos/licencias/agregar" class="btn btn-primary btn-sm ml10" title="Nueva licencia">
                    ...
                    <tbody>
                      ...
                      @foreach($DatosLicencias as $DatLic)
                        ...
                        <tr class="message-unread">
                          ...
                          <!-- Modificar -->
                          <td style="text-align: center">
                            <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/ticactivos/licencias/modificar/<?=$DatLic->id_licencia?>'">
