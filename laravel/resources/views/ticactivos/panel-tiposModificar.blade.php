                          ...
                          <tr>
                            <td>
                              <div class="allcp-form">
                                {!! Form::open(array('action' => 'TicActivos\TiposTicActivosPanelController@TiposModificarDB', 'class' => 'form', 'id'=>'form-wizard')) !!}
                                  ...
                                  <div class="row">
                                    <div class="col-md-4">
                                      ...
                                      <label class="field prepend-icon">
                                        {!! Form::text('descripcion', $DatTip->descripcion, array('required', 'id'=>'descripcion', 'class'=>'gui-input', 'placeholder'=>'* Descripción')) !!}
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <label class="option block">
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                          <label class="btn btn-secondary <?=$clas1?>" onclick="COLOR('S')">
                                            <i class="fa fa-desktop fa-1x" id="pcs" style="color:<?=$color1?>;"> Sí</i>
                                            <input type="radio" name="pc" value="S" autocomplete="off" <?=$inpu1?>>
                                          </label>
                                          <label class="btn btn-secondary <?=$clas2?>" onclick="COLOR('N')">
                                            <i class="fa fa-times-circle fa-1x" id="pcn" style="color:<?=$color2?>;"> No</i>
                                            <input type="radio" name="pc" value="N" autocomplete="off" <?=$inpu2?>>
                                          </label>
                                        </div>
                                      </label>
                                    </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <label class="field prepend-icon">
                                        {!! Form::text('campo1', $DatTip->campo1, array('', 'id'=>'campo1', 'class'=>'gui-input', 'placeholder'=>'Campo adicional 1')) !!}
                                        <label for="username" class="field-icon">
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <label class="field prepend-icon">
                                        {!! Form::text('campo2', $DatTip->campo2, array('', 'id'=>'campo2', 'class'=>'gui-input', 'placeholder'=>'Campo adicional 2')) !!}
                                        <label for="username" class="field-icon">
                                          <i class="fa fa-user"></i>
                                        </label>
                                      </label>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <label class="field prepend-icon">
                                        {!! Form::text('campo3', $DatTip->campo3, array('', 'id'=>'campo3', 'class'=>'gui-input', 'placeholder'=>'Campo adicional 3')) !!}
                                        <label for="username" class="field-icon">
                                          <i class="fa fa-user"></i>
                                        </label>
                                      </label>
                                  ...
                                  <div class="row">
                                    <div class="col-md-4">
                                      <br><br>
                                      {!! Form::submit('Modificar tipo', array('class'=>'button')) !!}
                                      <br><br>
                                    </div>
                                  </div>
                                {!! Form::close() !!}
