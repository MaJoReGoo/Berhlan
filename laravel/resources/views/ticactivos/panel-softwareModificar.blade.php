                    ...
                    <header id="topbar" class="ph10">
                        <div class="topbar-left">
                            <ul class="nav nav-list nav-list-topbar pull-left">
                                <li class="active">
                                    <a href="{{ asset('/panel/ticactivos/software') }}" title="Activos TIC > Software">
                                        <font color="#34495e">
                        ...
                        <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
                            <a href="{{ asset('/panel/ticactivos/software') }}" class="btn btn-primary btn-sm ml10"
                                title="Activos TIC > Software">
                                REGRESAR &nbsp;
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="allcp-form">
                                                            {!! Form::open([
                                                                'action' => 'TicActivos\SoftwareTicActivosPanelController@SoftwareModificarDB',
                                                                'class' => 'form',
                                                                'id' => 'form-wizard',
                                                            ]) !!}
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <label class="field prepend-icon">
                                                                        {!! Form::text('descripcion', $DatSof->descripcion, [
                                                                            'required',
                                                                            'id' => 'descripcion',
                                                                            'class' => 'gui-input',
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-5">
                                                                    <br><br>
                                                                    {!! Form::submit('Modificar software', ['class' => 'button']) !!}
                                                                </div>
                                                            </div>
                                                            {!! Form::close() !!}
                                                        </div>
