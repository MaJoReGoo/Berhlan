                                            ...
                                            <tr>
                                                <td>
                                                    <div class="allcp-form">
                                                        {!! Form::open([
                                                            'action' => 'TicActivos\ConsultasTicActivosPanelController@TareasListado',
                                                            'class' => 'form',
                                                            'id' => 'form-wizard',
                                                        ]) !!}
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <label class="field prepend-icon">
                                                                    {!! Form::date('fechadesde', null, ['', 'id' => 'fechadesde', 'class' => 'gui-input', 'maxlength' => '10']) !!}
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <label class="field prepend-icon">
                                                                    {!! Form::date('fechahasta', null, ['', 'id' => 'fechahasta', 'class' => 'gui-input', 'maxlength' => '10']) !!}
                                                                </label>
                                                            </div>
                                                        </div>
