            ...
            <header id="topbar" class="ph10">
              <div class="topbar-left">
                <ul class="nav nav-list nav-list-topbar pull-left">
                  <li class="active">
                    <a href="{{ asset ('/panel/ticactivos/licencias')}}" title="Activos TIC > Licencias de office">
                      <font color="#34495e">
              ...
              <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
                <a href="{{ asset ('/panel/ticactivos/licencias')}}" class="btn btn-primary btn-sm ml10" title="Activos TIC > Licencias de office">
                  REGRESAR &nbsp;
