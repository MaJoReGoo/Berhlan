                        ...
                        <div class="panel m10">
                            ...
                            <div class="table-responsive">
                                ...
                                <div style="padding-left: 10px">
                                    <br>
                                    {!! Form::open([
                                        'action' => 'Disciplinarios\SolicitudDisciplinariosPanelController@Solicitud',
                                        'class' => 'form',
                                        'id' => 'form-wizard',
                                    ]) !!}
                                    <label class="field prepend-icon">
                                        {!! Form::text('busqueda', null, [
                                            '',
                                            'id' => 'busqueda',
                                            'class' => 'gui-input',
                                            ...
                                            <tr class="message-unread">
                                                ...
                                                <td style="text-align: center">
                                                    <button type="button" class="btn btn-default light"
                                                        onclick="window.location.href='{{ asset('/panel/disciplinarios/solicitud/formulario/') }}<?= $DatEmpleados->id_empleado ?>'"
                                        ...
                                        <thead>
                                            <tr style="background-color:#39405a">
                                                <th>
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                    <font size="1">
                                                        (En proceso &nbsp;&nbsp;-&nbsp;&nbsp; Atendidas en los últimos
                                                        20 días)
                                                    </font>
                                                </th>
                                            </tr>
                                                            ...
                                                            <tr class="message-unread">
                                                                ...
                                                                <td style="text-align: center">
                                                                    <button type="button"
                                                                        ...
                                                                        onclick="window.location.href='{{ asset('/panel/disciplinarios/solicitud/masinfo/') }}<?= $DatSol->id_solicitud ?>'"
