          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="{{ asset ('/panel/disciplinarios/atender')}}" title="Procesos disciplinarios > Atender procesos">
                    <font color="#34495e">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="{{ asset ('/panel/disciplinarios/atender')}}" class="btn btn-primary btn-sm ml10" title="Procesos disciplinarios > Atender procesos">
                REGRESAR &nbsp;
