...
@foreach($DatosUsuario as $DatLog)
  ...
  <html>
    <head>
      ...
      <meta charset="utf-8">
      <title>
        Intranet | Procesos disciplinarios | Mis solicitudes
      </title>
          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/disciplinarios/solicitud" title="Procesos disciplinarios > Mis solicitudes">
                    <font color="#34495e">
                      Procesos disciplinarios > Mis solicitudes > Solicitud <?=$DatosSolicitud[0]->id_solicitud?> >
                    </font>
                    <font color="#b4c056">
                      Más información
                    </font>
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/disciplinarios/solicitud" class="btn btn-primary btn-sm ml10" title="Procesos disciplinarios > Mis solicitudes">
                REGRESAR &nbsp;
