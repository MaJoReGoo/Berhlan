                            ...
                            <tbody>
                              ...
                              @foreach($DatosSolicitudes as $DatSol)
                                <tr class="message-unread">
                                  ...
                                  <td style="text-align: center">
                                    <button type="button" class="btn btn-default light" onclick="window.location.href='{{ asset ('/panel/disciplinarios/atender/procesar/')}}<?=$DatSol->id_solicitud?>'" title="Más información">
                                      <?php
                                      if($DatSol->estado == 0)
