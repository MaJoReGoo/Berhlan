          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/disciplinarios/informe" title="Procesos disciplinarios > Informe">
                    <font color="#34495e">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/disciplinarios/informe" class="btn btn-primary btn-sm ml10" title="Procesos disciplinarios > Informe">
                REGRESAR &nbsp;
