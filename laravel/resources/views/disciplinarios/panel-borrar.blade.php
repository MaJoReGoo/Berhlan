                      ...
                      <thead>
                        <tr>
                          <th style="background-color:#67d3e0; color:#34495e; text-align:left;">
                            Cancelar un proceso disciplinario
                          </th>
                        </tr>
                      </thead>
                        ...
                        <tr>
                          <td>
                            <div class="allcp-form">
                              {!! Form::open(array('action' => 'Disciplinarios\SolicitudDisciplinariosPanelController@BorrarDetalle', 'class' => 'form', 'id'=>'form-wizard')) !!}
                                <div class="section">
                                  <div class="col-md-4">
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <label class="field prepend-icon">
                                      {!! Form::number('numsolicitud', null, array('', 'id'=>'numsolicitud', 'class'=>'gui-input', 'placeholder'=>'Proceso disciplinario', 'min'=>'1')) !!}
                                      <label for="username" class="field-icon">
                                        <i>PD -</i>
                                      </label>
                                    </label>
