                            ...
                            <tbody>
                              ...
                              @foreach($DatosSolicitud as $DatSol)
                                <tr class="message-unread">
                                  ...
                                  <td style="text-align: center">
                                    <button type="button" class="btn btn-default light" onclick="window.location.href='{{ asset ('/panel/disciplinarios/borrar/detalleb/')}}<?=$DatSol->id_solicitud?>'" title="Más información">
