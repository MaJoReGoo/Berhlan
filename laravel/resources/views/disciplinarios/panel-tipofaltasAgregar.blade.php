                ...
                <header id="topbar" class="ph10">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            <li class="active">
                                <a href="{{ asset('/panel/disciplinarios/tipofaltas') }}"
                                    title="Proceso disciplinario > Tipos de faltas">
                                    <font color="#34495e">
                    ...
                    <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
                        <a href="{{ asset('/panel/disciplinarios/tipofaltas') }}" class="btn btn-primary btn-sm ml10"
                            title="Proceso disciplinario > Tipos de faltas">
                            REGRESAR &nbsp;
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="allcp-form">
                                                        {!! Form::open([
                                                            'action' => 'Disciplinarios\TipofaltasDisciplinariosPanelController@TipofaltasAgregarDB',
                                                            'class' => 'form',
                                                            'id' => 'form-wizard',
                                                            'files' => true,
                                                        ]) !!}
                                                            ...
                                                            <div class="col-md-7">
                                                                ...
                                                                <label class="field prepend-icon">
                                                                    {!! Form::textarea('detalle', '', [
                                                                        ...
                                                                        'placeholder' => '* Detalle en que casos se debe seleccionar este tipo de falta',
                                                                    ]) !!}
                                                                    <label for="username" class="field-icon">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <br><br>
                                                                {!! Form::submit('Ingresar tipo de falta', ['class' => 'button']) !!}
                                                                <br><br>
                                                            </div>
                                                        </div>
                                                        {!! Form::close() !!}
