        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/disciplinarios/tipofaltas/agregar" class="btn btn-primary btn-sm ml10" title="Nuevo tipo de falta">
                <span class="fa fa-plus pr5"></span>
                <span class="fa fa-navicon pr5"></span>
              </a>

              <a href="<?=$server?>/panel/menu/45" class="btn btn-primary btn-sm ml10" title="Proceso disciplinario">
                REGRESAR &nbsp;
                    ...
                    <tbody>
                      ...
                      @foreach($DatosTipofaltas as $DatTpf)
                        ...
                        <tr class="message-unread">
                          ...
                          <td style="text-align:left">
                            <i class="fa fa-exclamation-circle fa-lg" style="color:<?=$color?>;"></i>
                            &nbsp;
                            <font color="#2A2F43">
                              <b>
                                <?=$DatTpf->descripcion?>
                          ...
                          <td style="text-align: center">
                            <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/disciplinarios/tipofaltas/modificar/<?=$DatTpf->id_tipofalta?>'">
