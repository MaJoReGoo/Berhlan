          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="{{ asset ('/panel/disciplinarios/borrar')}}" title="Procesos disciplinarios > Borrar proceso disciplinario">
                    <font color="#34495e">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="{{ asset ('/panel/disciplinarios/borrar')}}" class="btn btn-primary btn-sm ml10" title="Procesos disciplinarios > Borrar proceso disciplinario">
                REGRESAR &nbsp;
                      ...
                      <thead>
                        <tr style="background-color:#67d3e0">
                          <th style="color:black; text-align:left;">
                            Borrar solicitud PD-<?=$DatosSolicitud[0]->id_solicitud?>
                          </th>
                        </tr>
                      </thead>
                        ...
                        <tr>
                          <td>
                            <div class="allcp-form">
                              {!! Form::open(array('action' => 'Disciplinarios\SolicitudDisciplinariosPanelController@BorrarProcesarDB', 'class' => 'form', 'id'=>'form-wizard', 'onsubmit' => 'return confirm("¡Confirme el borrado!")')) !!}
                                {!! Form::hidden('solicitud', $DatosSolicitud[0]->id_solicitud) !!}
                                <div class="section">
                                  <div class="col-md-12">
                                    {!! Form::submit('Borrar proceso disciplinario', array('class'=>'button')) !!}
                                    <br><br>
                                  </div>
                                </div>
                              {!! Form::close() !!}
                        ...
                        <td>
                          <table id="message-table" class="table tc-checkbox-1 allcp-form theme-warning br-t table-striped">
                            ...
                            <tr style="background-color: #F8F8F8; color:#000000">
                              ...
                              <td colspan="3">
                                <button type="button" style="background:#f7f9f9;" class="btn btn-default light" onclick="window.open('{{ asset ('/panel/disciplinarios/textos/<?=$DatosSolicitud[0]->id_solicitud?>','_blank')" title="Citación - Acta - Decisión">
