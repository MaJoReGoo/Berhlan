...
@foreach ($DatosUsuario as $DatLog)
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css"
            href="{{ asset('/public/css/disciplinarios/panel-motivos.blade.css') }}">
            ...
            <section id="content_wrapper">
                ...
                <header id="topbar" class="ph10">
                    ...
                    <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
                        <a href="{{ asset('/panel/disciplinarios/motivos/agregar') }}"
                            class="btn btn-primary btn-sm ml10" title="Nuevo motivo de cierre">
                        ...
                        <div class="panel m10">
                            ...
                            <div class="table-responsive">
                                ...
                                <div style="padding-left: 10px">
                                    Cantidad de motivos de cierre:
                                    <?= $MotivosActivos + $MotivosInactivos ?>
                                    <font color="#b4c056">
                                        (<?= $MotivosActivos ?>)
                                    </font>
                                </div>
                                ...
                                <table id="message-table"
                                    ...
                                    <tbody>
                                        <?php $u = 1; ?>
                                        @foreach ($DatosMotivos as $DatMov)
                                            <?php
                                            if ($DatMov->estado == '0') {
                                                $color = '#F6565A';
                                            } else {
                                            ...
                                            <tr class="message-unread">
                                                ...
                                                <td style="text-align: left ">
                                                    <i class="fa fa-key fa-lg" style="color:<?= $color ?>;"></i>
                                                    &nbsp;
                                                    <font color="#2A2F43">
                                                        <b>
                                                            <?= $DatMov->descripcion ?>
                                                ...
                                                <td style="text-align: center">
                                                    <button type="button" class="btn btn-default light"
                                                        onclick="window.location.href='{{ asset('/panel/disciplinarios/motivos/modificar/') }}<?= $DatMov->id_motivocierre ?>'">
