          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/disciplinarios/solicitud" title="Procesos disciplinarios > Buscar colaborador">
                    <font color="#34495e">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/disciplinarios/solicitud" class="btn btn-primary btn-sm ml10" title="Procesos disciplinarios > Buscar colaborador">
                REGRESAR &nbsp;
                        ...
                        <tr>
                          <td>
                            <div class="allcp-form">
                              {!! Form::open(array('action' => 'Disciplinarios\SolicitudDisciplinariosPanelController@SolicitudAgregarDB', 'class' => 'form', 'id'=>'form-wizard')) !!}
                                ...
                                <div class="section">
                                      ...
                                      <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        @foreach($Faltas as $DatFal)
                                          ...
                                          if($u == 1)
                                           {
                                            ?>
                                            <label class="btn btn-secondary active" onclick="COLOR('<?=$u?>')">
                                              <i class="fa fa-check-square-o fa-lg" id="rad<?=$u?>" style="color:green;"></i>
                                              <input type="radio" name="falta" value="<?=$DatFal->id_tipofalta?>" autocomplete="off" checked>
                                            </label>
                                            <?php
                                           }
                                          else
                                           {
                                            ?>
                                            <label class="btn btn-secondary" onclick="COLOR('<?=$u?>')">
                                              <i class="fa fa-square-o fa-lg" id="rad<?=$u?>" style="color:green;"></i>
                                              <input type="radio" name="falta" value="<?=$DatFal->id_tipofalta?>" autocomplete="off">
                                            </label>
                                            <?php
                                           }
                                  ...
                                  <div class="col-md-7">
                                    ...
                                    <label class="field prepend-icon">
                                      {!! Form::textarea('causa', '', array('required', 'id'=>'causa', 'class'=>'gui-input', 'style'=>'height: 80px; resize: vertical;',
                                  ...
                                  <div class="col-md-3">
                                    ...
                                    <label class="field prepend-icon">
                                      {!! Form::date('conocimiento', null, array('required', 'id'=>'conocimiento', 'class'=>'gui-input', 'maxlength'=>'10')) !!}
                                    </label>
                                  </div>
                                  ...
                                  <div class="col-md-7">
                                    ...
                                    <label class="field prepend-icon">
                                      {!! Form::textarea('testigos', '', array('', 'id'=>'testigos', 'class'=>'gui-input', 'style'=>'height: 80px; resize: vertical;',
                                  ...
                                  <div class="col-md-7">
                                    ...
                                    <label class="field prepend-icon">
                                      {!! Form::text('pruebas', null, array('', 'id'=>'pruebas', 'class'=>'gui-input', 'placeholder'=>'En caso de tener pruebas, por favor súbalas a un servicio en la nube, copie y pegue el enlace, en este campo.')) !!}
                                      <label for="username" class="field-icon">
