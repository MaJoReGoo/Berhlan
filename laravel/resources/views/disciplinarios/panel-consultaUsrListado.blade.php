          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/disciplinarios/consultausr" title="Procesos disciplinarios > Consulta solicitudes">
                    <font color="#34495e">
                      Procesos disciplinarios > Consulta solicitudes >
                    </font>
                    <font color="#b4c056">
                      Listado
                    </font>
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/disciplinarios/consultausr" class="btn btn-primary btn-sm ml10" title="Procesos disciplinarios > Consulta solicitudes">
                REGRESAR &nbsp;
                            ...
                            <tbody>
                              ...
                              @foreach($DatosSolicitudes as $DatSol)
                                <tr class="message-unread">
                                  ...
                                  <td style="text-align: center">
                                    <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/disciplinarios/consultausr/masinfo/<?=$DatSol->id_solicitud?>'" title="Más información">
