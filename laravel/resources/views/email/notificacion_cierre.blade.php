...
<link rel="stylesheet" type="text/css" href="{{ asset ('/public/css/email/notificacion_cierre.blade.css')}}">
                                        ...
                                        <tr>
                                            ...
                                            <td width="540">
                                                <table align="center" border="0" cellpadding="0" cellspacing="0" class="full" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" width="540">
                                                    ...
                                                    <tr>
                                                        <td align="center" class="center" style="margin: 0; font-weight: 300; font-size:16px ; color:#ffffff; font-family: 'Open Sans', Helvetica, Arial, sans-serif; line-height: 26px;mso-line-height-rule: exactly;">
                                                            <span>Fecha de Cierre: <span style="color: #ffc400;"> | {{$mensajel3}}</span></span><br />
                                                        </td>
                                                    </tr>
                                                    @endif
                                                    ...
                                                    <tr>
                                                        <td align="center" class="center" style="margin: 0; font-weight: 300; font-size:16px ; color:#ffffff; font-family: 'Open Sans', Helvetica, Arial, sans-serif; line-height: 26px;mso-line-height-rule: exactly;">
                                                            <br />
                                                            <span>Por favor confírmenos que hemos cumplido con su requerimiento <span style="color: #ffc400;"> antes de la Fecha de Cierre </span> , de lo contrario su ticket será cerrado automáticamente.</span>
                                                        </td>
                                                    </tr>
