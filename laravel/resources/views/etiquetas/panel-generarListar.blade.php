        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/etiquetas/generar" title="Etiquetas > Seleccionar ítem ">
                    <font color="#34495e">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/etiquetas/generar" class="btn btn-primary btn-sm ml10" title="Etiquetas > Seleccionar ítem ">
                REGRESAR  
          ...
          <section id="content" class="table-layout animated fadeIn">
            <div class="chute chute-center pt0">
              ...
              Cancon:   <input type="text" id="cancon"   style="width:350;" maxlength="30" placeholder="123456" onblur="CANCON('')">
              ...
              <?php $e++; ?>
                <div id="imprime_<?=$e?>">
                  <table border="0" align="center" style="width:380px; background-color:white; border-spacing:0; color:#000000;" cellpadding="3" cellspacing="0">
                    <tr>
                      <td style="text-align:left; line-height:30px; vertical-align:baseline;" colspan="3">
                        <?php
                        ...
                        <b>
                          ...
                          <font style="font-size:15px; letter-spacing:0px; font-family:verdana, arial;">
                            <label id="lotetex_<?=$e?>"></label> <label id="octex_<?=$e?>"></label> <label id="cancontex_<?=$e?>"></label>
                          </font>
                        </b>
                      </td>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        <b>
                          <font style="font-size:14px; letter-spacing:0px; font-family:verdana, arial;">
                            <?php
