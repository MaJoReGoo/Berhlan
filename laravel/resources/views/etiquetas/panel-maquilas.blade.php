          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/menu/5" title="Etiquetas">
                    <font color="#34495e">
                      Códigos de barras >
                      <font color="#b4c056">
                        Maquilas
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/menu/5" class="btn btn-primary btn-sm ml10" title="Etiquetas">
                REGRESAR &nbsp;
                        ...
                        if($DatMaq->IDMAQUILA != $r)
                         {
                          ...
                          <tr class="message-unread">
                            ...
                            <td style="text-align: center">
                              <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/etiquetas/maquilas/modificar/<?=$DatMaq->IDMAQUILA?>'">
