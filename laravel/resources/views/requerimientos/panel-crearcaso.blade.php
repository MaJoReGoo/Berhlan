...
@foreach($DatosUsuario as $DatLog)
  ...
  <html>
    ...
    <body class="sales-stats-page">
                      ...
                      @foreach($DatosGrupos as $DatGru)
                        ...
                        <tr class="message-unread">
                          ...
                          <td style="text-align:left;">
                            <button type="button" class="btn btn-default light" onclick="ENVIAR('<?=$DatGru->id_grupo?>')">
      ...
      {!! Form::open(array('action' => 'Requerimientos\CrearRequerimientosPanelController@CrearCasoSeleccionar', 'class' => 'form', 'id'=>'form-wizard', 'name' => 'frmenvio')) !!}
        {!! Form::hidden('Grupo', '') !!}
      {!! Form::close() !!}
