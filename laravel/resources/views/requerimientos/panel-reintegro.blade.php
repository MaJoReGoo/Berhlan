                      ...
                      @foreach($DatosGrupos as $DatGru)
                        ...
                        <tr class="message-unread">
                          ...
                          <td style="text-align:left;">
                            <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/requerimientos/reintegro/listado/<?=$DatGru->id_grupo?>'">
