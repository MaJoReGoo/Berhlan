          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/requerimientos/consultagru/formulario/<?=$DatosSolicitud[0]->grupo?>" title="Requerimientos > Consulta parametrizada">
                    <font color="#34495e">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/requerimientos/consultagru/formulario/<?=$DatosSolicitud[0]->grupo?>" class="btn btn-primary btn-sm ml10" title="Requerimientos > Consulta parametrizada">
                REGRESAR &nbsp;
