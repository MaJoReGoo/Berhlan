            ...
            <section id="content_wrapper">
                ...
                <header id="topbar" class="ph10">
                    ...
                    <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
                        <a href="<?= $server ?>/panel/requerimientos/grupos/agregar" class="btn btn-primary btn-sm ml10"
                            title="Nuevo grupo">
                            <span class="fa fa-plus pr5"></span>
                            <span class="fa fa-credit-card pr5"></span>
                        </a>

                        <a href="<?= $server ?>/panel/menu/4" class="btn btn-primary btn-sm ml10"
                                                ...
                                                <tr class="message-unread">
                                                    ...
                                                    <td style="text-align: center">
                                                        <button type="button" style="background-color:transparent;"
                                                            ...
                                                            onclick="window.location.href='<?= $server ?>/panel/requerimientos/grupos/modificar/<?= $DatGru->id_grupo ?>'">
