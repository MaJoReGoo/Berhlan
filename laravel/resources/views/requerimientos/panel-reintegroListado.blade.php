            ...
            <section id="content_wrapper">
                ...
                <header id="topbar" class="ph10">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            <li class="active">
                                ...
                                ?>
                                <a href="{{ asset('/panel/requerimientos/reintegro') }}"
                                    title="Requerimientos > Reintegro">
                                    <font color="#34495e">
                    ...
                    <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
                        <a href="{{ asset('/panel/requerimientos/reintegro') }}" class="btn btn-primary btn-sm ml10"
                            title="Requerimientos > Reintegro">
                            REGRESAR &nbsp;
                                                            ...
                                                            <tr class="message-unread">
                                                                ...
                                                                <td style="text-align: center">
                                                                    <button type="button"
                                                                        ...
                                                                        onclick="window.location.href='{{ asset('/panel/requerimientos/reintegro/finalizar/') }}<?= $DatSol->num_solicitud ?>'"
