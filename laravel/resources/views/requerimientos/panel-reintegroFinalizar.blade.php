                    ...
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            <li class="active">
                                ...
                                ?>
                                <a href="{{ asset('/panel/requerimientos/reintegro/listado/') }}<?= $nomgrupo[0]->id_grupo ?>"
                                    title="Requerimientos > Grupo <?= $nomgrupo[0]->descripcion ?> > Reintegro">
                                    <font color="#34495e">
                    ...
                    <div class="chute chute-center pt30">
                        ...
                        <div class="panel m3">
                            <div class="nano-content">
                                <div class="table-responsive">
                                    {!! Form::open([
                                        'action' => 'Requerimientos\ReintegroRequerimientosPanelController@ReintegroFinalizarDB',
                                        'class' => 'form',
                                        'id' => 'form-wizard',
                                    ]) !!}
                                ...
                                else
                                 {
                                  ...
                                  ?>
                                                            ...
                                                            <button type="button" style="background:#f7f9f9;"
                                                                ...
                                                                onclick="window.location.href='{{ asset('/archivos/Requerimientos/') }}<?= $DatosSolicitud[0]->archivo ?>'"
                                                                title="Descargar">
                        ...
                        <div class="panel m3">
                            <div class="nano-content">
                                <div class="table-responsive">
                                    <table id="message-table" class="table allcp-form theme-warning br-t"
                                        border="1" style="border-color:#39405a">
                                        <tr>
