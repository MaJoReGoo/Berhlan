        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  ...
                  ?>
                  <a href="<?=$server?>/panel/requerimientos/reintegro/listado/<?=$nomgrupo[0]->id_grupo?>" title="Requerimientos > Grupo <?=$nomgrupo[0]->descripcion?> > Reintegro">
                    <font color="#34495e">
                      Requerimientos > Grupo <?=$nomgrupo[0]->descripcion?> > Reintegro >
                    </font>
                    <font color="#b4c056">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/requerimientos/reintegro/listado/<?=$nomgrupo[0]->id_grupo?>" class="btn btn-primary btn-sm ml10" title="Requerimientos > Grupo <?=$nomgrupo[0]->descripcion?> > Reintegro">
                REGRESAR &nbsp;
          ...
          <section id="content" class="table-layout animated fadeIn">
            <div class="chute chute-center pt30">
              ...
              <div class="panel m3">
                <div class="nano-content">
                  <div class="table-responsive">
                    {!! Form::open(array('action' => 'Requerimientos\ReintegroRequerimientosPanelController@ReintegroFinalizarDB', 'class' => 'form', 'id'=>'form-wizard')) !!}
                      {!! Form::hidden('solicitud', $DatosSolicitud[0]->num_solicitud) !!}

                      <table id="message-table" class="table allcp-form theme-warning br-t">
                        <tr>
                          <th style="background-color:#67d3e0; color:#34495e; text-align:left;" width="200">
                            Reintegro
                          </th>
                          ...
                          <td width="40">
                            ...
                            <label class="field prepend-icon">
                              {!! Form::date('fecha', date('Y-m-d'), array('required', 'id'=>'fecha', 'class'=>'gui-input', 'maxlength'=>'10')) !!}
                            </label>
                          </td>
                          ...
                          <td width="600">
                            ...
                            <label class="field prepend-icon">
                              {!! Form::textarea('descripcion', '', array('id'=>'descripcion', 'class'=>'gui-input', 'style'=>'height:45px;', 'placeholder'=>'Observaciones.')) !!}
                        ...
                        <td>
                          <table id="message-table" class="table tc-checkbox-1 allcp-form theme-warning br-t table-striped">
                            <tr style="background-color: #F8F8F8; color:#000000">
                              ...
                              <td style="text-align:left">
                                <?php
                                $atendido = PanelEmpleados::getEmpleado($DatosSolicitud[0]->usr_cierre);
                              ...
                              <td style="text-align:left">
                                ...
                                if($nombrearc == '')
                                ...
                                else
                                 {
                                  ...
                                  <button type="button" style="background:#f7f9f9;" class="btn btn-default light" onclick="window.location.href='<?=$server?>/archivos/Requerimientos/<?=$DatosSolicitud[0]->archivo?>'" title="Descargar">
              ...
              <div class="panel m3">
                <div class="nano-content">
                  <div class="table-responsive">
                    <table id="message-table" class="table allcp-form theme-warning br-t" border="1" style="border-color:#39405a">
                      <tr>
                        <th style="background-color:#39405a">
                          Seguimiento
                        </th>
                      </tr>
                          ...
                          <table id="message-table" class="table tc-checkbox-1 allcp-form theme-warning br-t table-striped">
                            ...
                            @foreach($Seguimientos as $DatSeg)
                              <tr style="background-color: #F8F8F8; color:#000000">
                                ...
                                <td style="text-align:left">
                                  Cordial saludo, <?=$DatSeg->descripcion?>
                                </td>
