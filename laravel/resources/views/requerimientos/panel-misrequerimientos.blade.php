              ...
              <div class="table-responsive">
                      ...
                      <tr>
                        <td>
                          <div class="allcp-form">
                            {!! Form::open(array('action' => 'Requerimientos\MisRequerimientosPanelController@SolicitudAgregarDB', 'class' => 'form', 'id'=>'form-wizard', 'files' => true)) !!}
                            <div class="row">
                              <div class="col-md-6">
                                <label style="color: #34495e">
                                  <b>
                                ...
                                <label class="field prepend-icon">
                                  {!! Form::textarea('descripcion', '', array('required', 'id'=>'descripcion', 'class'=>'gui-input', 'style'=>'height: 130px; resize: vertical;',
                              ...
                              <div class="section">
                                <div class="col-md-6">
                                  <div class="col-md-12">
                                    <label style="color: #34495e">
                                      <strong>Archivos Adjunto | (Word, Excel, PDF, Imagen)</strong><br />
                                      <span style="color: #e03131;">* Puede subir varios de ser necesario</span><br /><br />
                                    </label>
                                    <label class="field prepend-icon append-button file">
                                      ...
                                      {!! Form::file('files[]',
                                      array('', 'id'=>'files[]', 'accept'=>'.docx, .doc, .xls, .xlsx, .pdf, .jpg, .jpeg, .gif, .png',
                                      'class'=>'gui-file',
                                      'multiple',
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div id="notificaciones">
                                    <div class="col-md-6">
                                      ...
                                      <label class="field">
                                        ...
                                        <label class="field prepend-icon">
                                          {!! Form::email("email_notificacion", null, array("required"=>"true","id"=>"email_notificacion", "class"=>"gui-input","placeholder"=>" * Email")) !!}
                                          <label for="username" class="field-icon">
                                            <i class="fa fa-envelope"></i>
                                          </label>
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <label class="fieldt">
                                        ...
                                        <label class="field prepend-icon">
                                          {!! Form::text("cel_notificacion", null, array("required"=>"true", "id"=>"cel_notificacion", "class"=>"gui-input", "placeholder"=>"* Celular (WhatsApp)")) !!}
                                          <label for="username" class="field-icon">
                                            <i class="fa fa-phone"></i>
                                          </label>
                                        </label>
                                  ...
                                  <div class="col-md-6">
                                    <br><br><br>
                                    {!! Form::submit('Crear', array('class'=>'my-button','style'=>'color: #ffffff')) !!}
                                  </div>
                                </div>
                ...
                <?php } else { ?>
                  <div style="padding: 10px 10px 10px 10px;">
                    <span style="color: #000000; font-size: 18px">Para crear un nuevo Ticket <span style="color: #bf616a"><strong> debe primero cerrar </strong></span>, los tickets (<span style="color: #bf616a"><strong><?= $CantRerParaCerrar ?></strong></span>) pendientes de cierre.</span>
                    <br />
                  </div>
                <?php } ?>
                  ...
                  <thead>
                    <tr style="background-color:#2B547E; color: #ffffff">
                      <th>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <font size="1">
                          ( Abiertos &nbsp;&nbsp;-&nbsp;&nbsp; Cerrados en los últimos 20 días )
                        </font>
                      </th>
                    </tr>
                  </thead>
                          ...
                          <tr class="message-unread">
                              ...
                              <font color="#2A2F43">
                                <b>
                                  ...
                                  if ($DatSol->fecha_propuesta_cierre != '' && ($DatSol->estado == 1 || $DatSol->estado == 2)) { ?>
                                    <br />
                                    <span style="color: #e03131;">Ticket Pendiente de Cierre</span>
                                  <?php }
                                  ?>
                                </b>
                              </font>
                            ...
                            <td style="text-align:center">
                              ...
                              ?>
                                ...
                                <br />
                                <font color="#2A2F43"><?= $NomEmpleado ?><br /><?= $ApeEmpleado ?></font>
                              <?php
                              } else { ?>
                                <button type="button" class="btn btn-default light" disabled>
                                  <i class="fa fa-user fa-lg" style="color:#269ec5;"></i>&nbsp;
                                </button>
                                <br />
                                <font color="#2A2F43"> Pendiende por Asignar </font>
                              <?php }  ?>
                            </td>
                            ...
                            <td style="text-align: center">
                              <button type="button" class="btn btn-default light" onclick="window.location.href='<?= $server ?>/panel/requerimientos/misrequerimientos/masinfo/<?= $DatSol->num_solicitud ?>'" title="Más información">
                                <?php
                                if ($estado > 2)
                                  echo "<div>";
                                ?>
                                <i class="fa fa-plus fa-lg" style="color:#67d3e0;"></i>
                                <?php
                                if ($estado > 2)
                                  echo "</div>";
                                ?>
