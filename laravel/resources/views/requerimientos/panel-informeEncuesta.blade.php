                ...
                <div class="col-sm-3 col-xl-2">
                    <div class="col-xs-12 ph10 text-center  panel panel-body">
                        <i class="fa fa-3x" style="color:#FEDA00; text-shadow: 1px -1px 1px #000;">
                            <img src="/Berhlan/public/images/requerimientos/feliz.jpg" class="img-responsive mauto"
                                style="width: 70px; border-radius:6px; border:1;" />
                            <?= $muy ?>
                        </i>
                ...
                <div class="col-sm-3 col-xl-2">
                    <div class="col-xs-12 ph10 text-center  panel panel-body">
                        <i class="fa fa-3x" style="color:#FF8C19; text-shadow: 1px -1px 1px #000;">
                            <img src="/Berhlan/public/images/requerimientos/normal.jpg" class="img-responsive mauto"
                                style="width: 70px; border-radius:6px; border:1;" />
                            <?= $sas ?>
                        </i>
                        <h6 class="text-muted" style="padding-top: 20px">
                ...
                <div class="col-sm-3 col-xl-2">
                    <div class="col-xs-12 ph10 text-center  panel panel-body">
                        <i class="fa fa-3x" style="color:red; text-shadow: 1px -1px 1px #000;">
                            <img src="/Berhlan/public/images/requerimientos/triste.jpg" class="img-responsive mauto"
                                style="width: 70px; border-radius:6px; border:1;" />
                            <?= $ins ?>
                        </i>
                        <h6 class="text-muted" style="padding-top: 20px">
                                        ...
                                        <thead>
                                            <tr style="background-color:#39405a">
                                                <th style="color:white;" colspan="6">
                                                    Informe resultados de encuestas para el grupo
                                                            ...
                                                            <tr>
                                                                <td align="right">
                                                                    <button type="button"
                                                                        ...
                                                                        onclick="window.open('{{ asset('/panel/requerimientos/consultausr/masinfo1/') }}<?= $DatEnc->num_solicitud ?>','_blank','status=no','directories=no','menubar=no','toolbar=no','scrollbars=no','location=no','resizable=no','titlebar=no')"
                                                                ...
                                                                <td style="text-align:justify;">
                                                                    <div
                                                                        style="height:100px; width:100%; overflow-x:auto; overflow-x:hidden;">
                                                                        <?= $DatEnc->descripcion ?>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td style="text-align:justify;">
                                                                    <div
                                                                        style="height:100px; width:100%; overflow-x:auto;">
