      ...
      <header id="topbar" class="ph10">
        <div class="topbar-left">
          <ul class="nav nav-list nav-list-topbar pull-left">
            <li class="active">
              <a href="<?= $server ?>/panel/requerimientos/misrequerimientos" title="Requerimientos > Mis requerimientos">
                <font color="#34495e">
        ...
        <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
          <a href="<?= $server ?>/panel/requerimientos/misrequerimientos" class="btn btn-primary btn-sm ml10" title="Requerimientos > Mis requerimientos">
            REGRESAR &nbsp;
                    ...
                    <td>
                      <table id="message-table" class="table tc-checkbox-1 allcp-form theme-warning br-t table-striped">
                        ...
                        <tr style="background-color: #F8F8F8; color:#000000">
                          ...
                          <td style="text-align:left; font-size: 17px; color:blue; " colspan="3">
                            ...
                            <div class="section">
                              <div class="col-md-5">
                                <label class="field prepend-icon">
                                  {!! Form::textarea('descripcion', '', array('cols' => 4, 'required', 'id'=>'descripcion', 'class'=>'gui-input', 'style'=>'height: 80px;',
                              ...
                              <div class="col-md-3">
                                <br>
                                {!! Form::submit('Adicionar información', array('class'=>'my-button')) !!}
                              </div>
                            </div>
          ...
          if ($DatosSolicitud[0]->estado == 4) { ?>
            ...
            ?>
              ...
              <div class="panel m3">
                <div class="nano-content">
                  <div class="table-responsive">
                    {!! Form::open(array('action' => 'Requerimientos\AtenderRequerimientosPanelController@AtenderCerrarDB', 'class' => 'form', 'id'=>'formcerrar', 'name'=>'formcerrar', 'files' => true)) !!}
                    {!! Form::hidden('solicitud', $DatosSolicitud[0]->num_solicitud) !!}
                    {!! Form::hidden('grupo', $DatosSolicitud[0]->grupo) !!}
                        ...
                        <table id="message-table" class="table allcp-form theme-warning br-t">
                          <thead>
                            <tr style="background-color:#fa5252">
                              <th>
                                <spam style="color: #ffffff;">LA FECHA DE VENCIMIENTO MÁXIMO DEL TICKET YA FUE SUPERADA !</spam>
                              </th>
                            </tr>
                          </thead>
                        </table>
                          ...
                          <tr>
                            <td width="500">
                              <label class="field prepend-icon">
                                <?php if ($DatosSolicitud[0]->estado != 4 && $DatosSolicitud[0]->notificacion_cierre != 0) { ?>
                                  ...
                                  'placeholder'=>'* Mensaje de Cierre, sea breve y puntual.','required'=>'required')) !!}
                                <?php } else { ?>
                                  {!! Form::textarea('descripcion', '', array('cols' => 4, 'required', 'id'=>'descripcion', 'class'=>'gui-input', 'style'=>'height:45px;',
                                  'placeholder'=>'* Mensaje de Cierre, sea breve y puntual.', 'disabled'=>true)) !!}
                                <?php } ?>
                                <label for="username" class="field-icon">
                                  <i class="fa fa-reorder"></i>
                                </label>
                            ...
                            <td>
                              <label class="field prepend-icon append-button file">
                                ...
                                <?php } else { ?>
                                  {!! Form::file('file1', array('', 'id'=>'file1', 'class'=>'gui-file', 'onChange'=>"document.getElementById('uploader1').value = this.value;")) !!}
                                  {!! Form::text('uploader1', null, array('id'=>'uploader1', 'class'=>'gui-input', 'placeholder'=>'Seleccione el archivo', 'disabled'=>true)) !!}
                                <?php } ?>
                            ...
                            <td>
                              {!! Form::hidden('correoNotificacion', $DatosSolicitud[0]->email_notificacion) !!}
                              <?php if ($DatosSolicitud[0]->estado != 4 && $DatosSolicitud[0]->notificacion_cierre != 0) { ?>
                                <input type="submit" name="btEnviar" value="Cerrar" id="btnEnviar" class="my-button-env" style="color: #ffffff;" onclick="executeProcess(event)" />
                              <?php } else { ?>
        ...
        if ($DatosSolicitud[0]->estado == 4) { ?>
          ...
          ?>
            ...
            <div class="panel m3">
              <div class="nano-content">
                <div class="table-responsive">
                  {!! Form::open(array('action' => 'Requerimientos\AtenderRequerimientosPanelController@RechazarCerrarNotificacion', 'class' => 'form', 'id'=>'formrechazar', 'name'=>'formrechazar', 'files' => true)) !!}
                  {!! Form::hidden('solicitud', $DatosSolicitud[0]->num_solicitud) !!}
                  {!! Form::hidden('grupo', $DatosSolicitud[0]->grupo) !!}
                      ...
                      <table id="message-table" class="table allcp-form theme-warning br-t">
                        <tr>
                          <td width="500">
                            <label class="field prepend-icon">
                              <?php if ($DatosSolicitud[0]->estado != 4 && $DatosSolicitud[0]->notificacion_cierre != 0) { ?>
                                {!! Form::textarea('comentario_rechazo', '', array('cols' => 4, 'required', 'id'=>'comentario_rechazo', 'class'=>'gui-input', 'style'=>'height:45px;',
                                'placeholder'=>'* Motivo del Rechazo, sea breve y puntual.')) !!}
                              <?php } else { ?>
                                {!! Form::textarea('comentario_rechazo', '', array('cols' => 4, 'required', 'id'=>'comentario_rechazo', 'class'=>'gui-input', 'style'=>'height:45px;',
                                'placeholder'=>'* Motivo del Rechazo, sea breve y puntual.', 'disabled'=>true)) !!}
                              <?php } ?>
                              <label for="username" class="field-icon">
                                <i class="fa fa-reorder"></i>
                              </label>
                          ...
                          <td>
                            <label class="field prepend-icon append-button file">
                              ...
                              <?php } else { ?>
                                {!! Form::file('file2', array('', 'id'=>'file2', 'class'=>'gui-file', 'onChange'=>"document.getElementById('uploader2').value = this.value;")) !!}
                                {!! Form::text('uploader2', null, array('id'=>'uploader2', 'class'=>'gui-input', 'placeholder'=>'Seleccione el archivo', 'disabled'=>true)) !!}
                              <?php } ?>
                          ...
                          <td>
                            {!! Form::hidden('correoNotificacion', $DatosSolicitud[0]->email_notificacion) !!}
                            <?php if ($DatosSolicitud[0]->estado != 4 && $DatosSolicitud[0]->notificacion_cierre != 0) { ?>
                              <input type="submit" name="btEnviarR" value="Rechazar" id="btnEnviarR" class="my-button-envR" style="color: #ffffff;" onclick="executeProcessR(event)" />
                            <?php } else { ?>
                              {!! Form::submit('Rechazar', array('class'=>'button', 'disabled'=>true,'style'=>'background-color: #d9480f')) !!}
                            <?php } ?>
                          </td>
                        </tr>
                      </table>
                      ...
                      <table>
                        <tr>
                          <td>
                            ...
                            Fecha de Cierre Mínimo: <span style="color: #66a80f;"><?= $O_Util->fecha_texto($FechaCierreMinimo) ?></span> <br />
                            Fecha de Cierre Máximo: <span style="color: #e03131;"><?= $O_Util->fecha_texto($FechaCierreMaximo) ?></span> <br />
                          </td>
                        </tr>
                      </table>
                    <?php } ?>
