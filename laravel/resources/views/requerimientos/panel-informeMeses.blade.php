                      ...
                      <thead>
                        <tr style="background-color:#39405a">
                          <th style="color:white;" colspan="2">
                            Informe requerimientos por meses para el grupo <?=$nomgrupo[0]->descripcion?>
                          </th>
                        </tr>
                      </thead>
                            ...
                            <table valign="top" style="width:800px;">
                              <tr>
                                <th>
                                  ...
                                  ?>
                                  <!-- -------------- Diagrama de barras -------------- -->
                                  <canvas id="barencuesta" width="100%" height="40"></canvas>
                                        ...
                                        datasets: [
                                         {
                                          ...
                                          backgroundColor: ['#FEDA00', '#FEDA00', '#FEDA00', '#FEDA00', '#FEDA00', '#FEDA00', '#FEDA00', '#FEDA00', '#FEDA00', '#FEDA00', '#FEDA00', '#FEDA00'],
                                          borderColor: "#000000",
                                          data: [<?=$val1?>],
                                          borderWidth: 1
                                         },
                                         {
                                          label: "Satisfecho",
                                          backgroundColor: ['#FF8C19', '#FF8C19', '#FF8C19', '#FF8C19', '#FF8C19', '#FF8C19', '#FF8C19', '#FF8C19', '#FF8C19', '#FF8C19', '#FF8C19', '#FF8C19'],
                                          borderColor: "#000000",
                                          data: [<?=$val2?>],
                                          borderWidth: 1
                                         },
                            ...
                            <table valign="top" style="width:800px;">
                              <tr>
                                <th>
                                  ...
                                  ?>
                                  <!-- -------------- Diagrama de barras -------------- -->
                                  <canvas id="barencuesta1" width="100%" height="25"></canvas>
                                  <script type="text/javascript">
                              ...
                              <table valign="top" style="width:800px;">
                                <tr>
                                  <th>
                                    ...
                                    ?>
                                    <!-- -------------- Diagrama de barras -------------- -->
                                    <canvas id="<?=$nombregra?>" width="100%" height="40"></canvas>
                                    <script type="text/javascript">
