        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  ...
                  <a href="{{ asset ('/panel/requerimientos/categorias/listado/')}}<?=$Grupo?>" title="Requerimientos > Grupo <?=$nomgrupo[0]->descripcion?> > Categorías de cierre">
                    <font color="#34495e">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="{{ asset ('/panel/requerimientos/categorias/listado/')}}<?=$Grupo?>" class="btn btn-primary btn-sm ml10" title="Requerimientos > Grupo <?=$nomgrupo[0]->descripcion?> > Categorías de cierre">
                REGRESAR &nbsp;
