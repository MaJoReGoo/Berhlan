                        ...
                        <tr>
                          <td>
                            <div class="allcp-form">
                              {!! Form::open(array('action' => 'Requerimientos\GruposRequerimientosPanelController@GruposAgregarDB', 'class' => 'form', 'id'=>'form-wizard')) !!}
                                  ...
                                  <div class="col-md-2">
                                    ...
                                    <label class="field select">
                                      <select name="reintegro" id="reintegro" required>
                                        ...
                                        <option value="1" style="color:green;">Sí</option>
                                      </select>
                                      <i class="arrow"></i>
                                    </label>
                                  </div>
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <br><br>
                                    {!! Form::submit('Ingresar grupo', array('class'=>'button btn-primary')) !!}
                                    <br><br>
                                  </div>
                                </div>
                              {!! Form::close() !!}
