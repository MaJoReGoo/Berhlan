                        ...
                        <tr>
                          <td>
                            <div class="allcp-form">
                              {!! Form::open(array('action' => 'Requerimientos\ConsultasRequerimientosPanelController@ConsultaUsrListado', 'class' => 'form', 'id'=>'form-wizard')) !!}
                                <div class="row">
                                  <div class="col-md-3">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-3">
                                    ...
                                    <label class="field prepend-icon">
                                      {!! Form::date('aprdesde', null, array('', 'id'=>'aprdesde', 'class'=>'gui-input', 'maxlength'=>'10')) !!}
                                    </label>
                                  </div>
                                  ...
                                  <div class="col-md-3">
                                    ...
                                    <label class="field prepend-icon">
                                      {!! Form::date('aprhasta', null, array('', 'id'=>'aprhasta', 'class'=>'gui-input', 'maxlength'=>'10')) !!}
                                    </label>
                                  </div>
