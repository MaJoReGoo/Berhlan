...
@foreach ($DatosUsuario as $DatLog)
    ...
    <head>
      ...
      <link rel="stylesheet"
            type="text/css" href="{{ asset('/panelfiles/assets/allcp/forms/css/forms.css') }}">
                        ...
                        <div class="panel m3">
                            ...
                            <div class="nano-content">
                                <div class="table-responsive">
                                            ...
                                            @foreach ($Grupos as $DatGru)
                                                <tr>
                                                    ...
                                                    @foreach ($DatosCriterios as $DatCri)
                                                        ...
                                                        ?>
                                                        <td style="text-align:center;">
                                                            <input type="text" id="txttiempo_<?= $a ?>_<?= $b ?>"
                                                                size="4" maxlength="4"
                                                                value="<?= $Valor[0]->tiempo ?>"
                                                                style="text-align:right;">
                                                            <input type="hidden" id="txtidcri_<?= $a ?>_<?= $b ?>"
                                                                value="<?= $DatCri->id_criterio ?>">
                                                            <button type="button"
                                                                style="background-color:white ; cursor:default; outline:none;"
                                                                tabindex="-1" class="btn btn-default light">
                                                                <b>
                                                                    días&nbsp;&nbsp;
                                                                    <label for="username" class="field-icon">
                                                                        <i class="fa fa-exclamation-triangle fa-2x"
                                                                            style="color:<?= $DatCri->color ?>; text-shadow: 1px 1px 1px #000;"></i>
                                                                    </label>
                                                                </b>
                                                            </button>
                                                        </td>
                                                    ...
                                                    <td style="text-align:center;">
                                                        <button type="button" class="btn btn-default light"
                                                            onclick="EDITAR('<?= $a ?>','<?= $DatGru->id_grupo ?>')"
                                                            title="Modificar priorización del grupo <?= $DatGru->descripcion ?>">
                                    ...
                                    {!! Form::open([
                                        'action' => 'Requerimientos\PriorizacionRequerimientosPanelController@PriorizacionModificarDB',
                                        'class' => 'form',
                                        'id' => 'form-wizard',
                                        'name' => 'frmenvio',
                                    ]) !!}
