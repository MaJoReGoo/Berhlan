  ...
  <html>
    ...
    @foreach($EstadosRq as $DatEst)
      ...
      if($estado == 1)
       {
        $val1  = $DatEst->cant;
        $pval1 = round((($val1*100)/$t), 2);
       }
      else if($estado == 2)
       {
        $val2  = $DatEst->cant;
        $pval2 = round((($val2*100)/$t), 2);
       }
      else if($estado == 3)
       {
        $val3  = $DatEst->cant;
        $pval3 = round((($val3*100)/$t), 2);
       }
      else if($estado == 4)
       {
        $val4  = $DatEst->cant;
        $pval4 = round((($val4*100)/$t), 2);
       }
      ?>
    @endforeach

    <body onload="CIRESTADOS(<?=$val1?>, <?=$pval1?>, <?=$val2?>, <?=$pval2?>, <?=$val3?>, <?=$pval3?>, <?=$val4?>, <?=$pval4?>),
                  BARATENDIDOS(), CIRCRITICIDAD(), CIRPERCEPCION();">
      <!-- -------------- Body Wrap  -------------- -->
      <div id="main">
        <!-- -------------- Header  -------------- -->
                  ...
                  <div class="table-responsive">
                    <table id="message-table" class="table theme-warning br-t">
                      ...
                      <tbody>
                          ...
                          <td style="vertical-align: top;" colspan="3">
                            <table valign="top" style="width:800px;">
                              <tr>
                                <th>
                                  <!-- -------------- Imagen circular -------------- -->
                                  <canvas id="cirestados" width="100%" height="20"></canvas>
                                  <script type="text/javascript">
                                  function CIRESTADOS(val1, por1, val2, por2, val3, por3, val4, por4)
                                   {
                                    ...
                                    var myPieChart = new Chart(ctx,
                                     {
                                      ...
                                      data:
                                       {
                                        labels: ["Pendiente de asignación: "+por1+"%"+" ("+val1+")", "Asignado, en proceso: "+por2+"%"+" ("+val2+")",
                                                 "Atendido, pendiente encuesta de satisfacción: "+por3+"%"+" ("+val3+")", "Finalizado: "+por4+"%"+" ("+val4+")"],
                                        datasets: [
                                         {
                                          data: [val1, val2, val3, val4],
                                          backgroundColor: ['#FEDA00', '#00833A', '#A8CB2A', '#6CBCED'],
                                          borderColor: "white",
                                          borderWidth: 3
                                         }],
                                       },
                              ...
                              <tr>
                                <th>
                                  ...
                                  @foreach($EmpleadoRq as $DatEmR)
                                    <?php
                                   if ($DatEmR->usr_atiende != NULL) {
                                   // print $DatEmR->usr_atiende . "-". $DatEmR->cant . "<br>";
                        ...
                        <tr>
                          <th style="vertical-align: top;">
                            Requerimientos establecidos como "proyecto", que se encuentran en proceso:
                          </th>
                          <td style="vertical-align: top;" colspan="3">
                            <?php
                            $ProyectoRq = PanelSolicitudes::ConTProyectoUsuario($Grupo);
                            ?>
                            <table id="tablaproyecto" class="table theme-warning br-t" style="width:800px;">
                              <thead>
                              ...
                              @foreach($ProyectoRq as $DatReq)
                                <tr>
                                  <td>
                                    <?php
                                    $atiende = PanelEmpleados::getEmpleado($DatReq->usr_cierre);
                                    echo $atiende[0]->primer_nombre;
                                    echo " ";
                                    echo $atiende[0]->ot_nombre;
                                    echo " ";
                                    echo $atiende[0]->primer_apellido;
                                    echo " ";
                                    echo $atiende[0]->ot_apellido;
                                    ?>
                                  </td>
                        ...
                        <tr>
                          <th style="vertical-align: top;">
                            Requerimientos establecidos como "depende de terceros", que se encuentran en proceso:
                          </th>
                          <td style="vertical-align: top;" colspan="3">
                            <?php
                            $TercerosRq = PanelSolicitudes::ConTTercerosUsuario($Grupo);
                            ?>
                            <table id="tablaproyecto" class="table theme-warning br-t" style="width:800px;">
                              <thead>
                                <tr style="background-color:#67d3e0; color:#34495e;">
                            ...
                            <table id="tablaareas" class="table theme-warning br-t" style="width:800px;">
                              ...
                              @foreach($AreasRq as $DatAre)
                                <tr>
                                  ...
                                  /* echo "<th style=\"text-align:right\">";
                                    echo $prog1 = round(((($DatAre->cant-$ctaArea)*100)/$DatAre->cant), 2);
                                    echo "% &nbsp;";
                                    echo "<progress id=\"file\" max=\"100\" value=\"$prog1\" style=\"width:50px;\"> $prog1% </progress>";
                                  echo "</th>"; */
                                  ?>
                                </tr>
                              @endforeach
                        ...
                        <tr>
                          <th style="vertical-align: top;">
                            Requerimientos atendidos según su criticidad:
                            <br>
                            (fecha solicitud)
                          </th>
                          <td style="vertical-align: top;" colspan="3">
                            <table valign="top" style="width:800px;">
                              <tr>
                                <th>
                                  <?php
                                  $CriticidadRq = PanelSolicitudes::ConCriticidadRequerimientos($Grupo, $Desdehora, $Desdehasta);
                                  $val1 = $val2 = $val3 = $val4 = $pval1 = $pval2 = $pval3 = $pval4 = 0;
                                  $t = 0;
                                  $e = 0;
                                  ?>
                                  @foreach($CriticidadRq as $DatCri)
                                    <?php
                                    $t = $t + $DatCri->cant;
                                    ?>
                                  @endforeach
                                  ...
                                  @foreach($CriticidadRq as $DatCri)
                                    <?php
                                    if($DatCri->criticidad == 1)
                                     {
                                      $val1  = $DatCri->cant;
                                      $pval1 = round((($val1*100)/$t), 2);
                                     }
                                    else if($DatCri->criticidad == 2)
                                     {
                                      $val2  = $DatCri->cant;
                                      $pval2 = round((($val2*100)/$t), 2);
                                     }
                                    else if($DatCri->criticidad == 3)
                                     {
                                      $val3  = $DatCri->cant;
                                      $pval3 = round((($val3*100)/$t), 2);
                                     }
                                    else if($DatCri->criticidad == 4)
                                     {
                                      $val4  = $DatCri->cant;
                                      $pval4 = round((($val4*100)/$t), 2);
                                     }
                                  ...
                                  @endforeach
                                  <?php
                                  $texto = "'Crítico: $pval1% ($val1)', 'Alto: $pval2% ($val2)', 'Medio: $pval3% ($val3)', 'Bajo: $pval4% ($val4)'";
                                  ?>
                                  <!-- -------------- Imagen circular -------------- -->
                                  <canvas id="circriticidad" width="100%" height="20"></canvas>
                                  <script type="text/javascript">
                                  function CIRCRITICIDAD()
                                   {
                                    var ctx = document.getElementById("circriticidad");
                                    var myPieChart = new Chart(ctx,
                                     {
                                      type: 'doughnut',
                                      data:
                                       {
                                        ...
                                        datasets: [
                                         {
                                          data: [<?php echo $pval1;?>, <?php echo $pval2;?>, <?php echo $pval3;?>, <?php echo $pval4;?>],
                                ...
                                if($DatTie->diferencia > 0)
                                 {
                                  ...
                                  <tr>
                                    <th>
                                      <button type="button" class="btn btn-default light" onclick="window.open('{{ asset ('/panel/requerimientos/consultausr/masinfo1/')}}<?=$DatTie->num_solicitud?>','_blank','status=no','directories=no','menubar=no','toolbar=no','scrollbars=no','location=no','resizable=no','titlebar=no')" title="Más información">
                                        <font color="#34495e" size="3">
