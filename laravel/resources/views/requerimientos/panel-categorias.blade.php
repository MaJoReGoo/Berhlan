              ...
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="<?=$server?>/panel/menu/4" title="Requerimientos">
                    <font color="#34495e">
                      Requerimientos > Categorías de cierre
                    </font>
                  </a>
                </li>
              </ul>
                      ...
                      @foreach($DatosGrupos as $DatGru)
                        ...
                        <tr class="message-unread">
                          ...
                          <td style="text-align:left;">
                            <button type="button" class="btn btn-default light" onclick="window.location.href='<?=$server?>/panel/requerimientos/categorias/listado/<?=$DatGru->id_grupo?>'">
