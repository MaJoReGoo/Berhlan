                                        ...
                                        <thead>
                                            <tr style="background-color:#39405a">
                                                <th style="color:white;" colspan="6">
                                                    Informe de requerimientos para el grupo
                                        ...
                                        <tbody>
                                                    ...
                                                    <table valign="top" style="width:800px;">
                                                        <tr>
                                                            <th>
                                                                <br>
                                                                @php
                                                                    $EmpleadoRq = PanelSolicitudes::ConEmpleadosRequerimientos(
                                                                        $Grupo,
                                                                        $Desdehora,
                                                                        $Desdehasta,
                                                                    );
                                                                ...
                                                                @foreach ($EmpleadoRq as $DatEmR)
                                                                    @php
                                                                        if (
                                                                            $DatEmR->usr_atiende != '' &&
                                                                            $DatEmR->usr_atiende != null
                                                                        ) {
                                                                            $atiende = PanelEmpleados::getEmpleado(
                                                                                $DatEmR->usr_atiende,
                                                                            );
                                                                            $nombre =
                                                                                $atiende[0]->primer_nombre .
                                                                                '.' .
                                                                                $atiende[0]->primer_apellido;
                                                                            $nombres[$e] = $nombre;
                                                                ...
                                                                @endif
                                                                <!-- -------------- Diagrama de barras -------------- -->
                                                                <canvas id="baratendios" width="100%"
                                                                    height="35"></canvas>
                                                                    ...
                                                                    function BARATENDIDOS() {
                                                                        ...
                                                                        var myPieChart = new Chart(ctx, {
                                                                            ...
                                                                            data: {
                                                                                ...
                                                                                datasets: [{
                                                                                    label: "Atendidos",
                                                                                    backgroundColor: ['#FEDA00', '#00833A', '#A8CB2A', '#6CBCED', '#FEDA00', '#00833A',
                                                                                        '#A8CB2A', '#6CBCED', '#FEDA00', '#00833A', '#A8CB2A', '#6CBCED'
                                                                                    ],
                                                                                    borderColor: "#000000",
                                                                                    data: [<?= $val ?>],
                                                                                    borderWidth: 2
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: top;" colspan="3">
                                                    ...
                                                    ?>
                                                    <table id="tablaareas" class="table theme-warning br-t"
                                                        style="width:800px;">
                                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: top;" colspan="3">
                                                    ...
                                                    ?>
                                                    <table id="tablactg" class="table theme-warning br-t"
                                                        style="width:800px;">
                                                        <thead>
                                                            <tr style="background-color:#67d3e0; color:#34495e;">
                                                                <th>
                                                        ...
                                                        @foreach ($CtgRq as $DatCtg)
                                                            <tr>
                                                                ...
                                                                <th style="text-align:center">
                                                                    ...
                                                                    ?>
                                                                    <button type="button"
                                                                        style="text-align:left; cursor:default; outline:none; width:110px; background-color:white;"
                                                ...
                                                <td style="vertical-align: top;" colspan="3">
                                                    ...
                                                    <table id="message-table" class="table theme-warning br-t"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th style="text-align:center;">
                                                                <button type="button"
                                                                    style="background:#67d3e0; cursor:default;"
                                            ...
                                            <tr>
                                                <td style="vertical-align: top;" colspan="3">
                                                    ...
                                                    <table id="tablatiempos" class="table theme-warning br-t"
                                                        style="width:800px;">
                                                        <thead>
                                                            <tr style="background-color:#67d3e0; color:#34495e;">
                                                                <th>
                          ...
                          ?>
                                                            <tr>
                                                                <th>
                                                                    <button type="button"
                                                                        class="btn btn-default light"
                                                                        onclick="window.open('{{ asset('/panel/requerimientos/consultausr/masinfo1/') }}<?= $DatTie->num_solicitud ?>','_blank','status=no','directories=no','menubar=no','toolbar=no','scrollbars=no','location=no','resizable=no','titlebar=no')"
                                                    ...
                                                    <table valign="top" style="width:800px;">
                                                        <tr>
                                                            <th>
                                                                ...
                                                                ?>
                                                                <!-- -------------- Imagen circular -------------- -->
                                                                <canvas id="cirpercepcion" width="100%"
                                                                    height="20"></canvas>
                                                                <script type="text/javascript">
