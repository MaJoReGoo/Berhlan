...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset ('/public/css/requerimientos/panel-atenderProcesar.blade-220324.css')}}">
    ...
    <section id="content_wrapper">
      ...
      <header id="topbar" class="ph10">
        <div class="topbar-left">
          <ul class="nav nav-list nav-list-topbar pull-left">
            <li class="active">
              ...
              ?>
              <a href="{{ asset ('/panel/requerimientos/atender/listado/<?= $nomgrupo[0]->id_grupo ?>" title="Requerimientos > Grupo <?= $nomgrupo[0]->descripcion ?> > Atender">
                <font color="#34495e">
        ...
        <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
          <a href="{{ asset ('/panel/requerimientos/atender/listado/<?= $nomgrupo[0]->id_grupo ?>" class="btn btn-primary btn-sm ml10" title="Requerimientos > Grupo <?= $nomgrupo[0]->descripcion ?> > Atender">
            REGRESAR  
      ...
      <section id="content" class="table-layout animated fadeIn">
        <div class="chute chute-center pt30">
                        ...
                        <tr style="background-color: #F8F8F8; color:#000000">
                          ...
                          <td style="text-align:left">
                            ...
                            ?>
                              ...
                              <button type="button" style="background:#f7f9f9;" class="btn btn-default light" onclick="window.open('{{ asset ('/archivos/Requerimientos/<?= $DatosSolicitud[0]->archivo . "?" . date('i:s') ?>','_blank')" title="Descargar">
                      ...
                      <tr style="background-color: #F8F8F8; color:#000000">
                        ...
                        <td style="text-align:center">
                          ...
                          ?>
                            ...
                            <button type="button" style="background:##e5eaee;" class="btn btn-default light" onclick="window.open('{{ asset ('/archivos/Requerimientos/<?= $nombrearc . "?" . date('i:s') ?>','_blank')" title="Descargar">
                              <i class="fa <?= $icono ?> fa-lg" style="color:#<?= $fonicono ?>;"></i>
                            </button>
                          <?php
                          }
                        ...
                        <td style="text-align:center">
                          ...
                          ?>
                          <button type="button" class="btn btn-default light" onClick="infoEmpleado('<?= $infoEmpleado ?>')">
                            <i class="fa fa-user fa-lg" style="color:#269ec5;"></i>&nbsp;
                          </button>
                        </td>
                      </tr>
                      @endforeach
          ...
          <div class="panel m3">
            <div class="nano-content">
              <div class="table-responsive">
                {!! Form::open(array('action' => 'Requerimientos\AtenderRequerimientosPanelController@AtenderTrasladarDB', 'class' => 'form', 'id'=>'form-wizard')) !!}
                ...
                <table id="message-table" class="table allcp-form theme-warning br-t">
                  <tr>
                    ...
                    <td>
                      ...
                      {!! Form::submit('Trasladar', array('class'=>'button')) !!}
                    </td>
                  </tr>
                </table>
                {!! Form::close() !!}
          ...
          <div class="panel m3">
            <div class="nano-content">
              <div class="table-responsive">
                ...
                {!! Form::open(array('action' => 'Requerimientos\AtenderRequerimientosPanelController@AtenderAsignarDB', 'class' => 'form', 'id'=>'form-wizard')) !!}
                {!! Form::hidden('solicitud', $DatosSolicitud[0]->num_solicitud) !!}
                ...
                <table id="message-table" class="table allcp-form theme-warning br-t">
                  <tr>
                        ...
                        <select name="depende" id="depende">
                          ...
                          <option value="T" <?php
                                            if ($DatosSolicitud[0]->depende_de == "T")
                                              echo " selected ";
                                            ?>>Depende de terceros</option>
                          <option value="P" <?php
                                            if ($DatosSolicitud[0]->depende_de == "P")
                                              echo " selected ";
                                            ?>>Es un proyecto</option>
                        </select>
                        <i class="arrow"></i>
                      </label>
                    </td>
                    ...
                    <td>
                      {!! Form::hidden('correoNotificacion', $DatosSolicitud[0]->email_notificacion) !!}
                      {!! Form::submit('Asignar', array('class'=>'my-button','style'=>'color: #ffffff')) !!}
                    </td>
                  </tr>
                </table>
                {!! Form::close() !!}
              ...
              <div class="panel m3">
                <div class="nano-content">
                  <div class="table-responsive">
                    ...
                    {!! Form::open(array('action' => 'Requerimientos\AtenderRequerimientosPanelController@AtenderCerrarNotificacion', 'class' => 'form', 'id'=>'form-wizard', 'files' => true)) !!}
                    {!! Form::hidden('solicitud', $DatosSolicitud[0]->num_solicitud) !!}
                    {!! Form::hidden('grupo', $DatosSolicitud[0]->grupo) !!}
                    ...
                    <table id="message-table" class="table allcp-form theme-warning br-t" border="1">
                      <tr>
                        ...
                        if (isset($DatosSolicitud[0]->fecha_propuesta_cierre) && ($FechaCierreMaximo < date('Y-m-d')) && $DatosSolicitud[0]->estado != 4) { ?>
                          <td style="background-color:#fa5252;">
                            <spam style="color: #ffffff;">
                              <center>LA FECHA DE VENCIMIENTO MÁXIMO DEL TICKET <br /> YA FUE SUPERADA !</center>
                            </spam>
                          </td>
                        <?php
                        } else { ?>
                        ...
                        <td>
                          ...
                          <div class="section">
                            <div class="col-md-3 form-group">
                              <label style="color: #2B547E">Fecha de Plazo Para Cierre</label>
                              <label for="datepicker1" class="field prepend-icon">
                                ...
                                if (isset($DatosSolicitud[0]->fecha_propuesta_cierre)) {
                                  ...
                                  $FechaCierreMaximo = date("Y-m-d", strtotime($DatosSolicitud[0]->fecha_propuesta_cierre . "+" . $ParametrosNotificaciones->dias_max . "days"));
                                ?>
                                  Fecha de Notificación: <span style="color: #1864ab;"><?= $O_Util->fecha_texto($DatosSolicitud[0]->fecha_propuesta_cierre) ?></span> <br />
                                  Fecha de Cierre: <span style="color: #66a80f;"><?= $O_Util->fecha_texto($FechaCierreMinimo) ?></span> <br />
                                  Fecha Cierre Máx: <span style="color: #e03131;"><?= $O_Util->fecha_texto($FechaCierreMaximo) ?></span> <br />
                                <?php } ?>
                              </label>
                            </div>
                            <?php
                            ...
                            <div class="col-md-5 form-group">
                              <br />
                              {!! Form::textarea('comentario_cierre', '', array('cols' => 4, 'required', 'id'=>'comentario_cierre', 'class'=>'gui-input', 'style'=>'height: 45px;','placeholder'=>'* Comentario de Cierre')) !!}
                            </div>
                            <?php
                            // }
                            ...
                            if (isset($DatosSolicitud[0]->fecha_propuesta_cierre) && ($FechaCierreMaximo < date('Y-m-d')) && $DatosSolicitud[0]->estado != 4) { ?>
                              <div class="col-md-2 form-group">
                                <br />
                                {!! Form::hidden('correoNotificacion', $DatosSolicitud[0]->email_notificacion) !!}
                                {!! Form::submit('Enviar Notificación', array('class'=>'button','disabled', 'style'=>'background-color: #00763b')) !!}
                              </div>
                              <div class="col-md-1 form-group">
                                <br />
                                <i class="fa fa-whatsapp fa-2x" style="color: #999999"></i>&nbsp;
                              </div>
                            <?php
                            } else { ?>
                              <div class="col-md-2 form-group">
                                <br />
                                {!! Form::hidden('correoNotificacion', $DatosSolicitud[0]->email_notificacion) !!}
                                {!! Form::submit('Enviar Notificación', array('class'=>'button', 'style'=>'background-color: #00763b')) !!}
                              </div>
                              <?php
                        ...
                        %0A<?= $shortURL ?>" target="blank"><i class="fa fa-whatsapp fa-2x" style="color: #444444"></i></a>&nbsp;
                              </div>
                            <?php } ?>
                          </div>
                    ...
                    if (
                      ...
                      <div class="panel m3">
                        <div class="nano-content">
                          <div class="table-responsive">
                            {!! Form::open(array('action' => 'Requerimientos\AtenderRequerimientosPanelController@AtenderCerrarDB', 'class' => 'form', 'id'=>'form-wizard', 'files' => true)) !!}
                            {!! Form::hidden('solicitud', $DatosSolicitud[0]->num_solicitud) !!}
                            {!! Form::hidden('grupo', $DatosSolicitud[0]->grupo) !!}
                            {!! Form::hidden('aplreintegro', $nomgrupo[0]->reintegro) !!}
                              ...
                              <tr>
                                ...
                                <td width="500">
                                  <label class="field prepend-icon">
                                    {!! Form::textarea('descripcion', '', array('cols' => 4, 'required', 'id'=>'descripcion', 'class'=>'gui-input', 'style'=>'height:45px;',
                                ...
                                <td>
                                  {!! Form::hidden('correoNotificacion', $DatosSolicitud[0]->email_notificacion) !!}
                                  {!! Form::submit('Cerrar', array('class'=>'button', 'style'=>'background-color: #00763b')) !!}
                                </td>
                              </tr>
                            </table>
                            {!! Form::close() !!}
                ...
                <div class="nano-content">
                  <div class="table-responsive">
                    ...
                    <table id="message-table" class="table allcp-form">
                      <tr>
                        <th style="background-color: #8e949e; color:#ffffff; text-align:left;" width="400">
                          Cerrar (Enviar notificación al Usuario Para Cerrar el Caso)
                        </th>
                        <td>
                          {!! Form::hidden('correoNotificacion', $DatosSolicitud[0]->email_notificacion) !!}
                          {!! Form::submit('Cerrar', array('class'=>'button', 'disabled'=>'true','style'=>'background-color: #00763b')) !!}
                        </td>
                      </tr>
                    </table>
                    {!! Form::close() !!}
              ...
              <div class="panel m3">
                <div class="nano-content">
                  <div class="table-responsive">
                    ...
                    <table id="message-table" class="table allcp-form theme-warning br-t">
                      <tr>
                        <th style="background-color:#2B547E; color:#ffffff; text-align:left;" width="200">
                          Cerrar Ticket
                        </th>
                        ...
                        <td>
                          {!! Form::hidden('correoNotificacion', $DatosSolicitud[0]->email_notificacion) !!}
                          {!! Form::submit('Cerrar', array('class'=>'button')) !!}
                        </td>
                      </tr>
                    </table>
                    {!! Form::close() !!}
          ...
          <div class="panel m3">
            <div class="nano-content">
              <div class="table-responsive">
                ...
                {!! Form::open(array('action' => 'Requerimientos\MisRequerimientosPanelController@InformacionAgregarDB', 'class' => 'form', 'id'=>'form-wizard', 'files' => true)) !!}
                {!! Form::hidden('solicitud', $DatosSolicitud[0]->num_solicitud) !!}
                {!! Form::hidden('titulo_solicitud', $DatosSolicitud[0]->descripcion) !!}
                {!! Form::hidden('grupo', $DatosSolicitud[0]->grupo) !!}
                  ...
                  <tr>
                    ...
                    <td style="color:#34495e; text-align:right;" width="200">
                      <label class="field prepend-icon append-button file">
                        ...
                        {!! Form::file('file2', array('', 'id'=>'file2', 'class'=>'gui-file', 'onChange'=>"document.getElementById('uploader2').value = this.value;")) !!}
                        {!! Form::text('uploader2', null, array('id'=>'uploader2', 'class'=>'gui-input', 'placeholder'=>'Seleccione el archivo')) !!}
                        <label class="field-icon">
                          <i class="fa fa-cloud-upload"></i>
                        </label>
                      </label>
                    ...
                    <td>
                      {!! Form::hidden('correoNotificacion', $DatosSolicitud[0]->email_notificacion) !!}
                      {!! Form::submit('Adicionar información', array('class'=>'my-button-2')) !!}
                    </td>
                  </tr>
                  <tr>
                    <td><br /></td>
                ...
                <table id="message-table" class="table allcp-form theme-warning br-t" border="1" style="border-color:#2B547E">
                  <tr>
                    <td>
                      <table id="message-table" class="table tc-checkbox-1 allcp-form theme-warning br-t table-striped">
                        <tr>
                        ...
                        <tr style="background-color: #F8F8F8; color:#000000">
                          ...
                          <td style="text-align:left">
                            ...
                            <font style="color: <?= $ColorFont ?>;"><?= $DatSeg->descripcion ?></font>
                          </td>
                          ...
                          <td style="text-align:center">
                            ...
                            ?>
                              <?php if (($ext1 == 'jpg') || ($ext1 == 'png') || ($ext1 == 'gif') || ($ext1 == 'JPG') || ($ext1 == 'PNG') || ($ext1 == 'GIF')) { ?>
                                <button type="button" style="background:#e5eaee;" class="btn btn-default light" data-toggle="modal" data-target="#myModal<?= $numModal ?>" title="Descargar">
                                  <i class="fa <?= $icono ?> fa-lg" style="color:#<?= $fonicono ?>;"></i>
                                </button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <img class="img-responsive" style="margin:0 auto;" src="https://localhost{{ asset ('/archivos/Requerimientos/<?= $nombrearcD ?>" alt="">
