          ...
          <header id="topbar" class="ph10">
            <div class="topbar-left">
              <ul class="nav nav-list nav-list-topbar pull-left">
                <li class="active">
                  <a href="javascript:history.back()" title="Requerimientos > Consulta parametrizada > Listado">
                    <font color="#34495e">
                      Requerimientos > Consulta parametrizada > Listado >
                    </font>
                    <font color="#b4c056">
                      Más información
                    </font>
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="javascript:history.back()" class="btn btn-primary btn-sm ml10" title="Requerimientos > Consulta parametrizada > Listado">
                REGRESAR &nbsp;
