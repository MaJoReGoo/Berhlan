                    ...
                    @foreach($DatosSolicitudes as $DatTie)
                      <tr>
                        <th style="text-align: right;">
                          <button type="button" style="background: transparent; border: solid 1px; color: black; text-align: center;" class="btn btn-default light" onclick="window.open('{{ asset ('/panel/requerimientos/consultausr/masinfo1/')}}<?=$DatTie->num_solicitud?>','_blank','status=no','directories=no','menubar=no','toolbar=no','scrollbars=no','location=no','resizable=no','titlebar=no')" title="Más información">
