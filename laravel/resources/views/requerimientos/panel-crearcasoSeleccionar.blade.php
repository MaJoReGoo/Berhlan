...
@foreach ($DatosUsuario as $DatLog)
    ...
    <body>
                ...
                <header id="topbar" class="ph10">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            <li class="active">
                                <a href="{{ asset('/panel/requerimientos/crearcaso') }}"
                                    title="Requerimientos > Crear caso">
                                    <font color="#34495e">
                                        Requerimientos >
                                        <?php
                    ...
                    <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
                        <a href="{{ asset('/panel/requerimientos/crearcaso') }}" class="btn btn-primary btn-sm ml10"
                            title="Requerimientos > Crear caso">
                            REGRESAR &nbsp;
                            ...
                            <div class="nano-content">
                                <div class="table-responsive">
                                    ...
                                    <div style="padding-left: 10px">
                                        <br>
                                        {!! Form::open([
                                            'action' => 'Requerimientos\CrearRequerimientosPanelController@CrearCasoSeleccionar',
                                            'class' => 'form',
                                            'id' => 'form-wizard',
                                        ]) !!}
                                                ...
                                                <tr class="message-unread">
                                                    ...
                                                    <td style="text-align: center">
                                                        <button type="button" class="btn btn-default light"
                                                            onclick="ENVIAR('<?= $DatEmpleados->id_empleado ?>')"
        ...
        {!! Form::open([
            'action' => 'Requerimientos\CrearRequerimientosPanelController@CrearCasoAgregar',
            'class' => 'form',
            'id' => 'form-wizard',
            'name' => 'frmenvio',
        ]) !!}
