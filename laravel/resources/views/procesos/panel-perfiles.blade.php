        ...
        <section id="content_wrapper">
          ...
          <header id="topbar" class="ph10">
            ...
            <div class="topbar-right hidden-xs hidden-sm mt5 mr35">
              <a href="<?=$server?>/panel/procesos/perfiles/agregar" class="btn btn-primary btn-sm ml10" title="Nuevo perfil">
            ...
            <div class="chute chute-center pt30">
              ...
              <div class="panel m10">
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                      ...
                      @foreach($DatosPerfiles as $DatPer)
                        <tr class="message-unread">
                          ...
                          <td>
                            <?php
                            $Usuarios = PanelPerfiles::getUsuariosPerfil($DatPer->id_perfil);
                            ?>
                            <b>
                              @foreach($Usuarios as $DatLogin)
                                ({{$DatLogin->primer_nombre}} {{$DatLogin->primer_apellido}})
                                &nbsp;
                              @endforeach
                            </b>
                          </td>
                  ...
                  {!! Form::open(array('action' => 'Procesos\PerfilesProcesosPanelController@PerfilesEliminarDB', 'class' => 'form', 'id'=>'form-wizard', 'name' => 'frmenvio')) !!}
                    {!! Form::hidden('login', $DatLog->login) !!}
                    {!! Form::hidden('id_perfil', '') !!}
                  {!! Form::close() !!}

                  <script language="javascript" type="text/javascript">
                    function BORRAR(per, nom)
                     {
                      var id  = per;
                      var id1 = nom;

                      if(!(confirm("Confirme el borrado del perfil ("+id1+").")))
                        return false;
