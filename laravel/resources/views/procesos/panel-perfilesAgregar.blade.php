...
@foreach($DatosUsuario as $DatLog)
  ...
  <html>
    <head>
      ...
      <meta charset="utf-8">
      <title>
        Intranet | Procesos | Agregar perfil
      </title>
                    ...
                    <table id="message-table" class="table allcp-form theme-warning br-t">
                      <thead>
                        <tr style="background-color:#39405a">
                          <th>
                            Ingrese la información del nuevo perfil
                          </th>
                       </tr>
                      </thead>
                        ...
                        <tr>
                          <td>
                            <div class="allcp-form">
                              {!! Form::open(array('action' => 'Procesos\PerfilesProcesosPanelController@PerfilesAgregarDB', 'class' => 'form', 'id'=>'form-wizard')) !!}
                                ...
                                <div class="section">
                                  ...
                                  <div class="col-md-6">
                                    <br><br>
                                    {!! Form::submit('Ingresar perfil', array('class'=>'button')) !!}
                                    <br><br>
                                  </div>
                                </div>
                              {!! Form::close() !!}
