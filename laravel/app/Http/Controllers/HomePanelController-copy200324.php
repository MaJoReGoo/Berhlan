...
class HomePanelController extends Controller
{
    ...
    public function showLoginVerification()
    {
        ...
        if ($UsuarioExiste == 0) {
            ...
            if ($InfoUsuario == 0) {
                //$Mensaje = "No existe el usuario " . $user." Recuerde que su usuario es su número de identificación";
                $Mensaje = '';
                                $Mensaje .= "No existe el usuario " . $user.'<br/>';
                                $Mensaje .= "<strong>Recuerde que su usuario es su número de identificación </strong><br/>";
                $Redireccion = "/panel/login";
                return view('panel-mensaje-login')->with('Mensaje', $Mensaje)->with('Redireccion', $Redireccion);
            } else {
